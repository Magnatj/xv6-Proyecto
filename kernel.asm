...
8010003a:	c7 44 24 04 d0 83 10 	movl   $0x801083d0,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 20 c8 10 80 	movl   $0x8010c820,(%esp)
80100049:	e8 a8 4d 00 00       	call   80104df6 <initlock>
...
801000bd:	e8 55 4d 00 00       	call   80104e17 <acquire>
...
80100104:	e8 70 4d 00 00       	call   80104e79 <release>
        return b;
...
8010017c:	e8 f8 4c 00 00       	call   80104e79 <release>
      return b;
...
80100198:	c7 04 24 d7 83 10 80 	movl   $0x801083d7,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 e8 83 10 80 	movl   $0x801083e8,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 ef 83 10 80 	movl   $0x801083ef,(%esp)
80100230:	e8 08 03 00 00       	call   8010053d <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 20 c8 10 80 	movl   $0x8010c820,(%esp)
8010023c:	e8 d6 4b 00 00       	call   80104e17 <acquire>
...
801002a9:	e8 cb 4b 00 00       	call   80104e79 <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bc:	e8 56 4a 00 00       	call   80104e17 <acquire>
...
801003c6:	75 0c                	jne    801003d4 <cprintf+0x33>
    panic("null fmt");
801003c8:	c7 04 24 f6 83 10 80 	movl   $0x801083f6,(%esp)
...
801004ad:	74 20                	je     801004cf <cprintf+0x12e>
        s = "(null)";
801004af:	c7 45 ec ff 83 10 80 	movl   $0x801083ff,-0x14(%ebp)
      for(; *s; s++)
...
80100536:	e8 3e 49 00 00       	call   80104e79 <release>
}
8010053b:	c9                   	leave  
8010053c:	c3                   	ret    
...
80100562:	c7 04 24 06 84 10 80 	movl   $0x80108406,(%esp)
...
80100574:	e8 28 fe ff ff       	call   801003a1 <cprintf>
  cprintf("\n");
80100579:	c7 04 24 15 84 10 80 	movl   $0x80108415,(%esp)
...
80100592:	e8 31 49 00 00       	call   80104ec8 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005ab:	c7 04 24 17 84 10 80 	movl   $0x80108417,(%esp)
...
801006b2:	e8 82 4a 00 00       	call   80105139 <memmove>
    pos -= 80;
...
801006e1:	e8 80 49 00 00       	call   80105066 <memset>
  }
...
80100776:	e8 a6 62 00 00       	call   80106a21 <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 9a 62 00 00       	call   80106a21 <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 8e 62 00 00       	call   80106a21 <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 81 62 00 00       	call   80106a21 <uartputc>
  cgaputc(c);
...
801007ba:	e8 58 46 00 00       	call   80104e17 <acquire>
  while((c = getc()) >= 0){
...
8010091e:	e8 56 45 00 00       	call   80104e79 <release>
}
80100923:	c9                   	leave  
80100924:	c3                   	ret    
...
80100943:	e8 cf 44 00 00       	call   80104e17 <acquire>
  while(n > 0){
...
80100961:	e8 13 45 00 00       	call   80104e79 <release>
        ilock(ip);
...
80100a08:	e8 6c 44 00 00       	call   80104e79 <release>
  ilock(ip);
...
80100a3e:	e8 d4 43 00 00       	call   80104e17 <acquire>
  for(i = 0; i < n; i++)
...
80100a78:	e8 fc 43 00 00       	call   80104e79 <release>
  ilock(ip);
...
80100a93:	c7 44 24 04 1b 84 10 	movl   $0x8010841b,0x4(%esp)
80100a9a:	80 
80100a9b:	c7 04 24 80 b7 10 80 	movl   $0x8010b780,(%esp)
80100aa2:	e8 4f 43 00 00       	call   80104df6 <initlock>
  initlock(&input.lock, "input");
80100aa7:	c7 44 24 04 23 84 10 	movl   $0x80108423,0x4(%esp)
80100aae:	80 
80100aaf:	c7 04 24 60 df 10 80 	movl   $0x8010df60,(%esp)
80100ab6:	e8 3b 43 00 00       	call   80104df6 <initlock>
...
80100b6e:	0f 85 3f 03 00 00    	jne    80100eb3 <exec+0x3b7>
  ...
  if((pgdir = setupkvm()) == 0)
80100b74:	e8 ec 6f 00 00       	call   80107b65 <setupkvm>
...
80100c0d:	e8 25 73 00 00       	call   80107f37 <allocuvm>
...
80100c4a:	e8 f9 71 00 00       	call   80107e48 <loaduvm>
...
80100cb5:	e8 7d 72 00 00       	call   80107f37 <allocuvm>
...
80100cd9:	e8 7d 74 00 00       	call   8010815b <clearpteu>
  sp = sz;
...
80100d08:	e8 d7 45 00 00       	call   801052e4 <strlen>
...
80100d26:	e8 b9 45 00 00       	call   801052e4 <strlen>
...
80100d50:	e8 cb 75 00 00       	call   80108320 <copyout>
...
80100df0:	e8 2b 75 00 00       	call   80108320 <copyout>
...
80100e47:	e8 4a 44 00 00       	call   80105296 <safestrcpy>
...
80100e99:	e8 b8 6d 00 00       	call   80107c56 <switchuvm>
  freevm(oldpgdir);
80100e9e:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100ea1:	89 04 24             	mov    %eax,(%esp)
80100ea4:	e8 24 72 00 00       	call   801080cd <freevm>
  return 0;
...
80100edb:	e8 ed 71 00 00       	call   801080cd <freevm>
  if(ip)
...
80100efe:	c7 44 24 04 29 84 10 	movl   $0x80108429,0x4(%esp)
80100f05:	80 
80100f06:	c7 04 24 20 e0 10 80 	movl   $0x8010e020,(%esp)
80100f0d:	e8 e4 3e 00 00       	call   80104df6 <initlock>
}
80100f12:	c9                   	leave  
80100f13:	c3                   	ret    
...
80100f21:	e8 f1 3e 00 00       	call   80104e17 <acquire>
...
80100f4a:	e8 2a 3f 00 00       	call   80104e79 <release>
      return f;
...
80100f68:	e8 0c 3f 00 00       	call   80104e79 <release>
  return 0;
...
80100f81:	e8 91 3e 00 00       	call   80104e17 <acquire>
  if(f->ref < 1)
...
80100f8e:	7f 0c                	jg     80100f9c <filedup+0x28>
    panic("filedup");
80100f90:	c7 04 24 30 84 10 80 	movl   $0x80108430,(%esp)
...
80100fb2:	e8 c2 3e 00 00       	call   80104e79 <release>
  return f;
...
80100fc9:	e8 49 3e 00 00       	call   80104e17 <acquire>
  if(f->ref < 1)
...
80100fd6:	7f 0c                	jg     80100fe4 <fileclose+0x28>
    panic("fileclose");
80100fd8:	c7 04 24 38 84 10 80 	movl   $0x80108438,(%esp)
...
80101004:	e8 70 3e 00 00       	call   80104e79 <release>
    return;
...
8010104e:	e8 26 3e 00 00       	call   80104e79 <release>
...
8010118d:	eb 0c                	jmp    8010119b <fileread+0xba>
  ...
  panic("fileread");
8010118f:	c7 04 24 42 84 10 80 	movl   $0x80108442,(%esp)
...
8010129b:	c7 04 24 4b 84 10 80 	movl   $0x8010844b,(%esp)
...
801012ce:	eb 0c                	jmp    801012dc <filewrite+0x13f>
  ...
  panic("filewrite");
801012d0:	c7 04 24 5b 84 10 80 	movl   $0x8010845b,(%esp)
...
80101318:	e8 1c 3e 00 00       	call   80105139 <memmove>
  brelse(bp);
...
8010135e:	e8 03 3d 00 00       	call   80105066 <memset>
  log_write(bp);
...
801014c0:	0f 82 e1 fe ff ff    	jb     801013a7 <balloc+0x2c>
  ...
  panic("balloc: out of blocks");
801014c6:	c7 04 24 65 84 10 80 	movl   $0x80108465,(%esp)
...
8010155d:	c7 04 24 7b 84 10 80 	movl   $0x8010847b,(%esp)
...
801015b1:	c7 44 24 04 8e 84 10 	movl   $0x8010848e,0x4(%esp)
801015b8:	80 
801015b9:	c7 04 24 20 ea 10 80 	movl   $0x8010ea20,(%esp)
801015c0:	e8 31 38 00 00       	call   80104df6 <initlock>
}
801015c5:	c9                   	leave  
801015c6:	c3                   	ret    
...
80101642:	e8 1f 3a 00 00       	call   80105066 <memset>
      dip->type = type;
...
80101692:	0f 82 5a ff ff ff    	jb     801015f2 <ialloc+0x2b>
  ...
  panic("ialloc: no inodes");
80101698:	c7 04 24 95 84 10 80 	movl   $0x80108495,(%esp)
...
8010173f:	e8 f5 39 00 00       	call   80105139 <memmove>
  log_write(bp);
...
80101769:	e8 a9 36 00 00       	call   80104e17 <acquire>
...
801017b3:	e8 c1 36 00 00       	call   80104e79 <release>
      return ip;
...
801017e6:	c7 04 24 a7 84 10 80 	movl   $0x801084a7,(%esp)
...
80101824:	e8 50 36 00 00       	call   80104e79 <release>
...
8010183b:	e8 d7 35 00 00       	call   80104e17 <acquire>
  ip->ref++;
...
80101856:	e8 1e 36 00 00       	call   80104e79 <release>
  return ip;
...
80101874:	7f 0c                	jg     80101882 <ilock+0x22>
    panic("ilock");
80101876:	c7 04 24 b7 84 10 80 	movl   $0x801084b7,(%esp)
8010187d:	e8 bb ec ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
80101882:	c7 04 24 20 ea 10 80 	movl   $0x8010ea20,(%esp)
80101889:	e8 89 35 00 00       	call   80104e17 <acquire>
...
801018c8:	e8 ac 35 00 00       	call   80104e79 <release>
...
80101973:	e8 c1 37 00 00       	call   80105139 <memmove>
    brelse(bp);
...
8010199e:	75 0c                	jne    801019ac <ilock+0x14c>
      panic("ilock: no type");
801019a0:	c7 04 24 bd 84 10 80 	movl   $0x801084bd,(%esp)
...
801019cf:	7f 0c                	jg     801019dd <iunlock+0x2f>
    panic("iunlock");
801019d1:	c7 04 24 cc 84 10 80 	movl   $0x801084cc,(%esp)
801019d8:	e8 60 eb ff ff       	call   8010053d <panic>

  acquire(&icache.lock);
801019dd:	c7 04 24 20 ea 10 80 	movl   $0x8010ea20,(%esp)
801019e4:	e8 2e 34 00 00       	call   80104e17 <acquire>
  ip->flags &= ~I_BUSY;
...
80101a0c:	e8 68 34 00 00       	call   80104e79 <release>
}
80101a11:	c9                   	leave  
80101a12:	c3                   	ret    
...
80101a20:	e8 f2 33 00 00       	call   80104e17 <acquire>
...
80101a5c:	74 0c                	je     80101a6a <iput+0x57>
      panic("iput busy");
80101a5e:	c7 04 24 d4 84 10 80 	movl   $0x801084d4,(%esp)
...
80101a82:	e8 f2 33 00 00       	call   80104e79 <release>
    itrunc(ip);
...
80101aad:	e8 65 33 00 00       	call   80104e17 <acquire>
    ip->flags = 0;
...
80101add:	e8 97 33 00 00       	call   80104e79 <release>
}
80101ae2:	c9                   	leave  
80101ae3:	c3                   	ret    
...
80101bf2:	c7 04 24 de 84 10 80 	movl   $0x801084de,(%esp)
...
80101e8a:	e8 aa 32 00 00       	call   80105139 <memmove>
    brelse(bp);
...
80101ff0:	e8 44 31 00 00       	call   80105139 <memmove>
    log_write(bp);
...
80102072:	e8 66 31 00 00       	call   801051dd <strncmp>
}
80102077:	c9                   	leave  
80102078:	c3                   	ret    
...
8010208c:	c7 04 24 f1 84 10 80 	movl   $0x801084f1,(%esp)
...
801020c8:	74 0c                	je     801020d6 <dirlookup+0x5d>
      panic("dirlink read");
801020ca:	c7 04 24 03 85 10 80 	movl   $0x80108503,(%esp)
...
801021ac:	74 0c                	je     801021ba <dirlink+0x79>
      panic("dirlink read");
801021ae:	c7 04 24 03 85 10 80 	movl   $0x80108503,(%esp)
...
801021f4:	e8 3c 30 00 00       	call   80105235 <strncpy>
  de.inum = inum;
...
80102224:	74 0c                	je     80102232 <dirlink+0xf1>
    panic("dirlink");
80102226:	c7 04 24 10 85 10 80 	movl   $0x80108510,(%esp)
...
801022ad:	e8 87 2e 00 00       	call   80105139 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022c8:	e8 6c 2e 00 00       	call   80105139 <memmove>
    name[len] = 0;
...
80102524:	c7 44 24 04 18 85 10 	movl   $0x80108518,0x4(%esp)
8010252b:	80 
8010252c:	c7 04 24 c0 b7 10 80 	movl   $0x8010b7c0,(%esp)
80102533:	e8 be 28 00 00       	call   80104df6 <initlock>
  picenable(IRQ_IDE);
...
801025ce:	75 0c                	jne    801025dc <idestart+0x18>
    panic("idestart");
801025d0:	c7 04 24 1c 85 10 80 	movl   $0x8010851c,(%esp)
...
801026f6:	e8 1c 27 00 00       	call   80104e17 <acquire>
  if((b = idequeue) == 0){
...
80102710:	e8 64 27 00 00       	call   80104e79 <release>
...
801027a5:	e8 cf 26 00 00       	call   80104e79 <release>
}
801027aa:	c9                   	leave  
801027ab:	c3                   	ret    
...
801027be:	c7 04 24 25 85 10 80 	movl   $0x80108525,(%esp)
...
801027d7:	c7 04 24 39 85 10 80 	movl   $0x80108539,(%esp)
...
8010287e:	e8 f6 25 00 00       	call   80104e79 <release>
}
80102883:	c9                   	leave  
80102884:	c3                   	ret    
...
8010290e:	c7 04 24 6c 85 10 80 	movl   $0x8010856c,(%esp)
...
801029cf:	c7 44 24 04 9e 85 10 	movl   $0x8010859e,0x4(%esp)
801029d6:	80 
801029d7:	c7 04 24 00 fa 10 80 	movl   $0x8010fa00,(%esp)
801029de:	e8 13 24 00 00       	call   80104df6 <initlock>
  kmem.use_lock = 0;
...
80102a89:	76 0c                	jbe    80102a97 <kfree+0x39>
    panic("kfree");
80102a8b:	c7 04 24 a3 85 10 80 	movl   $0x801085a3,(%esp)
...
80102aad:	e8 b4 25 00 00       	call   80105066 <memset>
...
80102ac2:	e8 50 23 00 00       	call   80104e17 <acquire>
  r = (struct run*)v;
...
80102af0:	e8 84 23 00 00       	call   80104e79 <release>
}
80102af5:	c9                   	leave  
80102af6:	c3                   	ret    
...
80102b0d:	e8 05 23 00 00       	call   80104e17 <acquire>
  r = kmem.freelist;
...
80102b3a:	e8 3a 23 00 00       	call   80104e79 <release>
  return (char*)r;
...
80102eb6:	c7 04 24 ac 85 10 80 	movl   $0x801085ac,(%esp)
...
8010300e:	c7 44 24 04 d8 85 10 	movl   $0x801085d8,0x4(%esp)
80103015:	80 
80103016:	c7 04 24 40 fa 10 80 	movl   $0x8010fa40,(%esp)
8010301d:	e8 d4 1d 00 00       	call   80104df6 <initlock>
  readsb(ROOTDEV, &sb);
...
801030d0:	e8 64 20 00 00       	call   80105139 <memmove>
...
80103222:	e8 f0 1b 00 00       	call   80104e17 <acquire>
  while (log.busy) {
...
80103257:	e8 1d 1c 00 00       	call   80104e79 <release>
}
8010325c:	c9                   	leave  
8010325d:	c3                   	ret    
...
8010328d:	e8 85 1b 00 00       	call   80104e17 <acquire>
  log.busy = 0;
...
801032af:	e8 c5 1b 00 00       	call   80104e79 <release>
}
801032b4:	c9                   	leave  
801032b5:	c3                   	ret    
...
801032d8:	c7 04 24 dc 85 10 80 	movl   $0x801085dc,(%esp)
...
801032ed:	c7 04 24 f2 85 10 80 	movl   $0x801085f2,(%esp)
...
8010337c:	e8 b8 1d 00 00       	call   80105139 <memmove>
  bwrite(lbuf);
...
80103440:	c7 04 24 09 86 10 80 	movl   $0x80108609,(%esp)
...
8010345b:	e8 b0 34 00 00       	call   80106910 <uartinit>
  pinit();         // process table
80103460:	e8 8e 0b 00 00       	call   80103ff3 <pinit>
  tvinit();        // trap vectors
80103465:	e8 49 30 00 00       	call   801064b3 <tvinit>
  binit();         // buffer cache
...
80103487:	e8 6a 2f 00 00       	call   801063f6 <timerinit>
...
801034b2:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
801034b5:	e8 7f 47 00 00       	call   80107c39 <switchkvm>
  seginit();
801034ba:	e8 06 41 00 00       	call   801075c5 <seginit>
  lapicinit();
...
801034df:	c7 04 24 20 86 10 80 	movl   $0x80108620,(%esp)
801034e6:	e8 b6 ce ff ff       	call   801003a1 <cprintf>
  idtinit();       // load idt register
801034eb:	e8 37 31 00 00       	call   80106627 <idtinit>
...
8010353d:	e8 f7 1b 00 00       	call   80105139 <memmove>
...
801036cb:	00 
801036cc:	c7 44 24 04 34 86 10 	movl   $0x80108634,0x4(%esp)
801036d3:	80 
801036d4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801036d7:	89 04 24             	mov    %eax,(%esp)
801036da:	e8 fe 19 00 00       	call   801050dd <memcmp>
...
8010380c:	00 
8010380d:	c7 44 24 04 39 86 10 	movl   $0x80108639,0x4(%esp)
80103814:	80 
80103815:	8b 45 f0             	mov    -0x10(%ebp),%eax
80103818:	89 04 24             	mov    %eax,(%esp)
8010381b:	e8 bd 18 00 00       	call   801050dd <memcmp>
...
801038e6:	8b 04 85 7c 86 10 80 	mov    -0x7fef7984(,%eax,4),%eax
...
8010391f:	c7 04 24 3e 86 10 80 	movl   $0x8010863e,(%esp)
...
801039b2:	c7 04 24 5c 86 10 80 	movl   $0x8010865c,(%esp)
...
80103cb7:	c7 44 24 04 90 86 10 	movl   $0x80108690,0x4(%esp)
80103cbe:	80 
80103cbf:	89 04 24             	mov    %eax,(%esp)
80103cc2:	e8 2f 11 00 00       	call   80104df6 <initlock>
  (*f0)->type = FD_PIPE;
...
80103d6f:	e8 a3 10 00 00       	call   80104e17 <acquire>
  if(writable){
...
80103dd6:	e8 9e 10 00 00       	call   80104e79 <release>
    kfree((char*)p);
...
80103dee:	e8 86 10 00 00       	call   80104e79 <release>
}
80103df3:	c9                   	leave  
80103df4:	c3                   	ret    
...
80103e02:	e8 10 10 00 00       	call   80104e17 <acquire>
  for(i = 0; i < n; i++){
...
80103e33:	e8 41 10 00 00       	call   80104e79 <release>
        return -1;
...
80103ed7:	e8 9d 0f 00 00       	call   80104e79 <release>
  return n;
...
80103ef2:	e8 20 0f 00 00       	call   80104e17 <acquire>
...
80103f0c:	e8 68 0f 00 00       	call   80104e79 <release>
      return -1;
...
80103fc9:	e8 ab 0e 00 00       	call   80104e79 <release>
  return i;
...
80103ff9:	c7 44 24 04 95 86 10 	movl   $0x80108695,0x4(%esp)
80104000:	80 
80104001:	c7 04 24 e0 00 11 80 	movl   $0x801100e0,(%esp)
80104008:	e8 e9 0d 00 00       	call   80104df6 <initlock>
}
8010400d:	c9                   	leave  
8010400e:	c3                   	ret    
...
8010401c:	e8 f6 0d 00 00       	call   80104e17 <acquire>
...
80104048:	e8 2c 0e 00 00       	call   80104e79 <release>
  return 0;
...
8010407c:	e8 f8 0d 00 00       	call   80104e79 <release>
...
801040c6:	ba 68 64 10 80       	mov    $0x80106468,%edx
...
801040f6:	e8 6b 0f 00 00       	call   80105066 <memset>
...
80104124:	e8 3c 3a 00 00       	call   80107b65 <setupkvm>
...
80104139:	c7 04 24 9c 86 10 80 	movl   $0x8010869c,(%esp)
...
8010415f:	e8 59 3c 00 00       	call   80107dbd <inituvm>
  p->sz = PGSIZE;
...
80104186:	e8 db 0e 00 00       	call   80105066 <memset>
...
801041ff:	00 
80104200:	c7 44 24 04 b5 86 10 	movl   $0x801086b5,0x4(%esp)
80104207:	80 
80104208:	89 04 24             	mov    %eax,(%esp)
8010420b:	e8 86 10 00 00       	call   80105296 <safestrcpy>
  p->cwd = namei("/");
80104210:	c7 04 24 be 86 10 80 	movl   $0x801086be,(%esp)
...
80104264:	e8 ce 3c 00 00       	call   80107f37 <allocuvm>
...
8010429e:	e8 6e 3d 00 00       	call   80108011 <deallocuvm>
...
801042c7:	e8 8a 39 00 00       	call   80107c56 <switchuvm>
  return 0;
...
8010430c:	e8 90 3e 00 00       	call   801081a1 <copyuvm>
...
80104426:	e8 6b 0e 00 00       	call   80105296 <safestrcpy>
  return pid;
...
8010444a:	75 0c                	jne    80104458 <exit+0x22>
    panic("init exiting");
8010444c:	c7 04 24 c0 86 10 80 	movl   $0x801086c0,(%esp)
...
801044d0:	e8 42 09 00 00       	call   80104e17 <acquire>
...
8010453d:	e8 b4 01 00 00       	call   801046f6 <sched>
  panic("zombie exit");
80104542:	c7 04 24 cd 86 10 80 	movl   $0x801086cd,(%esp)
...
8010455b:	e8 b7 08 00 00       	call   80104e17 <acquire>
  for(;;){
...
801045c3:	e8 05 3b 00 00       	call   801080cd <freevm>
        p->state = UNUSED;
...
801045fe:	e8 76 08 00 00       	call   80104e79 <release>
        return pid;
...
80104634:	e8 40 08 00 00       	call   80104e79 <release>
      return -1;
...
8010466f:	e8 a3 07 00 00       	call   80104e17 <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104697:	e8 ba 35 00 00       	call   80107c56 <switchuvm>
      p->state = RUNNING;
...
801046c0:	e8 47 0c 00 00       	call   8010530c <swtch>
      switchkvm();
801046c5:	e8 6f 35 00 00       	call   80107c39 <switchkvm>
...
801046ec:	e8 88 07 00 00       	call   80104e79 <release>
...
80104703:	e8 2d 08 00 00       	call   80104f35 <holding>
80104708:	85 c0                	test   %eax,%eax
8010470a:	75 0c                	jne    80104718 <sched+0x22>
    panic("sched ptable.lock");
8010470c:	c7 04 24 d9 86 10 80 	movl   $0x801086d9,(%esp)
...
80104727:	74 0c                	je     80104735 <sched+0x3f>
    panic("sched locks");
80104729:	c7 04 24 eb 86 10 80 	movl   $0x801086eb,(%esp)
...
80104741:	75 0c                	jne    8010474f <sched+0x59>
    panic("sched running");
80104743:	c7 04 24 f7 86 10 80 	movl   $0x801086f7,(%esp)
...
8010475d:	c7 04 24 05 87 10 80 	movl   $0x80108705,(%esp)
...
80104792:	e8 75 0b 00 00       	call   8010530c <swtch>
  cpu->intena = intena;
...
801047b5:	e8 5d 06 00 00       	call   80104e17 <acquire>
  proc->state = RUNNABLE;
...
801047d3:	e8 a1 06 00 00       	call   80104e79 <release>
}
801047d8:	c9                   	leave  
801047d9:	c3                   	ret    
...
801047e7:	e8 8d 06 00 00       	call   80104e79 <release>
...
80104814:	75 0c                	jne    80104822 <sleep+0x1c>
    panic("sleep");
80104816:	c7 04 24 19 87 10 80 	movl   $0x80108719,(%esp)
...
80104828:	c7 04 24 1f 87 10 80 	movl   $0x8010871f,(%esp)
...
80104844:	e8 ce 05 00 00       	call   80104e17 <acquire>
    release(lk);
80104849:	8b 45 0c             	mov    0xc(%ebp),%eax
8010484c:	89 04 24             	mov    %eax,(%esp)
8010484f:	e8 25 06 00 00       	call   80104e79 <release>
  }
...
8010488f:	e8 e5 05 00 00       	call   80104e79 <release>
    acquire(lk);
80104894:	8b 45 0c             	mov    0xc(%ebp),%eax
80104897:	89 04 24             	mov    %eax,(%esp)
8010489a:	e8 78 05 00 00       	call   80104e17 <acquire>
  }
}
8010489f:	c9                   	leave  
801048a0:	c3                   	ret    
...
801048ec:	e8 26 05 00 00       	call   80104e17 <acquire>
  wakeup1(chan);
...
80104903:	e8 71 05 00 00       	call   80104e79 <release>
}
80104908:	c9                   	leave  
80104909:	c3                   	ret    
...
80104917:	e8 fb 04 00 00       	call   80104e17 <acquire>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
...
80104956:	e8 1e 05 00 00       	call   80104e79 <release>
      return 0;
...
80104976:	e8 fe 04 00 00       	call   80104e79 <release>
  return -1;
...
801049ce:	eb 07                	jmp    801049d7 <procdump+0x55>
      ...
      state = "???";
801049d0:	c7 45 ec 30 87 10 80 	movl   $0x80108730,-0x14(%ebp)
...
801049f2:	c7 04 24 34 87 10 80 	movl   $0x80108734,(%esp)
...
80104a1f:	e8 a4 04 00 00       	call   80104ec8 <getcallerpcs>
...
80104a38:	c7 04 24 3d 87 10 80 	movl   $0x8010873d,(%esp)
...
80104a57:	75 d4                	jne    80104a2d <procdump+0xab>
    ...
    cprintf("\n");
80104a59:	c7 04 24 41 87 10 80 	movl   $0x80108741,(%esp)
...
80104a7f:	83 ec 20             	sub    $0x20,%esp
	long zi, lowprd, hi3l;

        if(seed<=0)
80104a82:	a1 10 b8 10 80       	mov    0x8010b810,%eax
80104a87:	85 c0                	test   %eax,%eax
80104a89:	7f 0a                	jg     80104a95 <sys_random+0x19>
	{
		seed = 0;
80104a8b:	c7 05 10 b8 10 80 00 	movl   $0x0,0x8010b810
80104a92:	00 00 00 
        }

        if(seed > 0 && seed < 101)
80104a95:	a1 10 b8 10 80       	mov    0x8010b810,%eax
80104a9a:	85 c0                	test   %eax,%eax
80104a9c:	0f 8e 08 01 00 00    	jle    80104baa <sys_random+0x12e>
80104aa2:	a1 10 b8 10 80       	mov    0x8010b810,%eax
80104aa7:	83 f8 64             	cmp    $0x64,%eax
80104aaa:	0f 8f fa 00 00 00    	jg     80104baa <sys_random+0x12e>
        {
                zi = zrng[seed];
80104ab0:	a1 10 b8 10 80       	mov    0x8010b810,%eax
80104ab5:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
80104abc:	89 45 fc             	mov    %eax,-0x4(%ebp)

                lowprd = (zi & 65535) * MULTONE;
80104abf:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104ac2:	25 ff ff 00 00       	and    $0xffff,%eax
80104ac7:	69 c0 30 5e 00 00    	imul   $0x5e30,%eax,%eax
80104acd:	89 45 f8             	mov    %eax,-0x8(%ebp)
                hi3l = (zi >> 16) * MULTONE + (lowprd >> 16);
80104ad0:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104ad3:	c1 f8 10             	sar    $0x10,%eax
80104ad6:	69 c0 30 5e 00 00    	imul   $0x5e30,%eax,%eax
80104adc:	8b 55 f8             	mov    -0x8(%ebp),%edx
80104adf:	c1 fa 10             	sar    $0x10,%edx
80104ae2:	01 d0                	add    %edx,%eax
80104ae4:	89 45 f4             	mov    %eax,-0xc(%ebp)
                zi = ((lowprd & 65535) - MODLUS) + ((hi3l & 32767) << 16) + (hi3l >> 15);
80104ae7:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104aea:	25 ff ff 00 00       	and    $0xffff,%eax
80104aef:	8d 90 01 00 00 80    	lea    -0x7fffffff(%eax),%edx
80104af5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104af8:	25 ff 7f 00 00       	and    $0x7fff,%eax
80104afd:	c1 e0 10             	shl    $0x10,%eax
80104b00:	01 c2                	add    %eax,%edx
80104b02:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b05:	c1 f8 0f             	sar    $0xf,%eax
80104b08:	01 d0                	add    %edx,%eax
80104b0a:	89 45 fc             	mov    %eax,-0x4(%ebp)

                if(zi < 0) zi += MODLUS;
80104b0d:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80104b11:	79 07                	jns    80104b1a <sys_random+0x9e>
80104b13:	81 45 fc ff ff ff 7f 	addl   $0x7fffffff,-0x4(%ebp)
                lowprd = (zi & 65535) * MULTTWO;
80104b1a:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104b1d:	25 ff ff 00 00       	and    $0xffff,%eax
80104b22:	69 c0 1f 66 00 00    	imul   $0x661f,%eax,%eax
80104b28:	89 45 f8             	mov    %eax,-0x8(%ebp)
                hi3l = (zi >> 16) * MULTTWO + (lowprd >> 16);
80104b2b:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104b2e:	c1 f8 10             	sar    $0x10,%eax
80104b31:	69 c0 1f 66 00 00    	imul   $0x661f,%eax,%eax
80104b37:	8b 55 f8             	mov    -0x8(%ebp),%edx
80104b3a:	c1 fa 10             	sar    $0x10,%edx
80104b3d:	01 d0                	add    %edx,%eax
80104b3f:	89 45 f4             	mov    %eax,-0xc(%ebp)
                zi = ((lowprd & 65535)-MODLUS) + ((hi3l &32767) << 16) + (hi3l >> 15);
80104b42:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104b45:	25 ff ff 00 00       	and    $0xffff,%eax
80104b4a:	8d 90 01 00 00 80    	lea    -0x7fffffff(%eax),%edx
80104b50:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b53:	25 ff 7f 00 00       	and    $0x7fff,%eax
80104b58:	c1 e0 10             	shl    $0x10,%eax
80104b5b:	01 c2                	add    %eax,%edx
80104b5d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104b60:	c1 f8 0f             	sar    $0xf,%eax
80104b63:	01 d0                	add    %edx,%eax
80104b65:	89 45 fc             	mov    %eax,-0x4(%ebp)

                if(zi < 0) zi += MODLUS;
80104b68:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80104b6c:	79 07                	jns    80104b75 <sys_random+0xf9>
80104b6e:	81 45 fc ff ff ff 7f 	addl   $0x7fffffff,-0x4(%ebp)
                zrng[seed] = zi;
80104b75:	a1 10 b8 10 80       	mov    0x8010b810,%eax
80104b7a:	8b 55 fc             	mov    -0x4(%ebp),%edx
80104b7d:	89 14 85 40 b0 10 80 	mov    %edx,-0x7fef4fc0(,%eax,4)

                randomValue = ((zi >> 7 | 1) + 1) / 1667772116.0;
80104b84:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104b87:	c1 f8 07             	sar    $0x7,%eax
80104b8a:	83 c8 01             	or     $0x1,%eax
80104b8d:	83 c0 01             	add    $0x1,%eax
80104b90:	89 45 e8             	mov    %eax,-0x18(%ebp)
80104b93:	db 45 e8             	fildl  -0x18(%ebp)
80104b96:	dd 05 70 87 10 80    	fldl   0x80108770
80104b9c:	de f9                	fdivrp %st,%st(1)
80104b9e:	d9 5d ec             	fstps  -0x14(%ebp)
80104ba1:	d9 45 ec             	flds   -0x14(%ebp)
80104ba4:	d9 1d 0c b8 10 80    	fstps  0x8010b80c
	}
	return randomValue;
80104baa:	a1 0c b8 10 80       	mov    0x8010b80c,%eax
80104baf:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80104bb2:	d9 45 e4             	flds   -0x1c(%ebp)
}
80104bb5:	c9                   	leave  
80104bb6:	c3                   	ret    

80104bb7 <sys_random_set>:
...
80104bba:	83 ec 38             	sub    $0x38,%esp
	long zi, lowprd, hi3l;

	if(argint(0, &seed)<0)
80104bbd:	c7 44 24 04 10 b8 10 	movl   $0x8010b810,0x4(%esp)
80104bc4:	80 
80104bc5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104bcc:	e8 f1 07 00 00       	call   801053c2 <argint>
80104bd1:	85 c0                	test   %eax,%eax
80104bd3:	79 0a                	jns    80104bdf <sys_random_set+0x28>
	{
		return -1;
80104bd5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104bda:	e9 21 01 00 00       	jmp    80104d00 <sys_random_set+0x149>
	}
	if(seed > 0 && seed < 101)
80104bdf:	a1 10 b8 10 80       	mov    0x8010b810,%eax
80104be4:	85 c0                	test   %eax,%eax
80104be6:	0f 8e 0f 01 00 00    	jle    80104cfb <sys_random_set+0x144>
80104bec:	a1 10 b8 10 80       	mov    0x8010b810,%eax
80104bf1:	83 f8 64             	cmp    $0x64,%eax
80104bf4:	0f 8f 01 01 00 00    	jg     80104cfb <sys_random_set+0x144>
	{		
		zi = zrng[seed];
80104bfa:	a1 10 b8 10 80       	mov    0x8010b810,%eax
80104bff:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
80104c06:	89 45 f4             	mov    %eax,-0xc(%ebp)
	
		lowprd = (zi & 65535) * MULTONE;
80104c09:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c0c:	25 ff ff 00 00       	and    $0xffff,%eax
80104c11:	69 c0 30 5e 00 00    	imul   $0x5e30,%eax,%eax
80104c17:	89 45 f0             	mov    %eax,-0x10(%ebp)
		hi3l = (zi >> 16) * MULTONE + (lowprd >> 16);
80104c1a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c1d:	c1 f8 10             	sar    $0x10,%eax
80104c20:	69 c0 30 5e 00 00    	imul   $0x5e30,%eax,%eax
80104c26:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104c29:	c1 fa 10             	sar    $0x10,%edx
80104c2c:	01 d0                	add    %edx,%eax
80104c2e:	89 45 ec             	mov    %eax,-0x14(%ebp)
		zi = ((lowprd & 65535) - MODLUS) + ((hi3l & 32767) << 16) + (hi3l >> 15);
80104c31:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c34:	25 ff ff 00 00       	and    $0xffff,%eax
80104c39:	8d 90 01 00 00 80    	lea    -0x7fffffff(%eax),%edx
80104c3f:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104c42:	25 ff 7f 00 00       	and    $0x7fff,%eax
80104c47:	c1 e0 10             	shl    $0x10,%eax
80104c4a:	01 c2                	add    %eax,%edx
80104c4c:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104c4f:	c1 f8 0f             	sar    $0xf,%eax
80104c52:	01 d0                	add    %edx,%eax
80104c54:	89 45 f4             	mov    %eax,-0xc(%ebp)
	
		if(zi < 0) zi += MODLUS;
80104c57:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80104c5b:	79 07                	jns    80104c64 <sys_random_set+0xad>
80104c5d:	81 45 f4 ff ff ff 7f 	addl   $0x7fffffff,-0xc(%ebp)
		lowprd = (zi & 65535) * MULTTWO;
80104c64:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c67:	25 ff ff 00 00       	and    $0xffff,%eax
80104c6c:	69 c0 1f 66 00 00    	imul   $0x661f,%eax,%eax
80104c72:	89 45 f0             	mov    %eax,-0x10(%ebp)
		hi3l = (zi >> 16) * MULTTWO + (lowprd >> 16);
80104c75:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c78:	c1 f8 10             	sar    $0x10,%eax
80104c7b:	69 c0 1f 66 00 00    	imul   $0x661f,%eax,%eax
80104c81:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104c84:	c1 fa 10             	sar    $0x10,%edx
80104c87:	01 d0                	add    %edx,%eax
80104c89:	89 45 ec             	mov    %eax,-0x14(%ebp)
		zi = ((lowprd & 65535)-MODLUS) + ((hi3l &32767) << 16) + (hi3l >> 15);
80104c8c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104c8f:	25 ff ff 00 00       	and    $0xffff,%eax
80104c94:	8d 90 01 00 00 80    	lea    -0x7fffffff(%eax),%edx
80104c9a:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104c9d:	25 ff 7f 00 00       	and    $0x7fff,%eax
80104ca2:	c1 e0 10             	shl    $0x10,%eax
80104ca5:	01 c2                	add    %eax,%edx
80104ca7:	8b 45 ec             	mov    -0x14(%ebp),%eax
80104caa:	c1 f8 0f             	sar    $0xf,%eax
80104cad:	01 d0                	add    %edx,%eax
80104caf:	89 45 f4             	mov    %eax,-0xc(%ebp)

		if(zi < 0) zi += MODLUS;
80104cb2:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80104cb6:	79 07                	jns    80104cbf <sys_random_set+0x108>
80104cb8:	81 45 f4 ff ff ff 7f 	addl   $0x7fffffff,-0xc(%ebp)
		zrng[seed] = zi;
80104cbf:	a1 10 b8 10 80       	mov    0x8010b810,%eax
80104cc4:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104cc7:	89 14 85 40 b0 10 80 	mov    %edx,-0x7fef4fc0(,%eax,4)
	
		randomValue = ((zi >> 7 | 1) + 1) / 1667772116.0; //¦
80104cce:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104cd1:	c1 f8 07             	sar    $0x7,%eax
80104cd4:	83 c8 01             	or     $0x1,%eax
80104cd7:	83 c0 01             	add    $0x1,%eax
80104cda:	89 45 e0             	mov    %eax,-0x20(%ebp)
80104cdd:	db 45 e0             	fildl  -0x20(%ebp)
80104ce0:	dd 05 70 87 10 80    	fldl   0x80108770
80104ce6:	de f9                	fdivrp %st,%st(1)
80104ce8:	d9 5d e4             	fstps  -0x1c(%ebp)
80104ceb:	d9 45 e4             	flds   -0x1c(%ebp)
80104cee:	d9 1d 0c b8 10 80    	fstps  0x8010b80c
	
		return 0;
80104cf4:	b8 00 00 00 00       	mov    $0x0,%eax
80104cf9:	eb 05                	jmp    80104d00 <sys_random_set+0x149>
	}
...
80104d05:	83 ec 28             	sub    $0x28,%esp
	int stream;
	argint(0, &stream);
80104d08:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104d0b:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d0f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104d16:	e8 a7 06 00 00       	call   801053c2 <argint>
	
	int  set;
	argint(1, &set);
80104d1b:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104d1e:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d22:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104d29:	e8 94 06 00 00       	call   801053c2 <argint>

	if(argint(0, &stream) < 0 )
80104d2e:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104d31:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d35:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104d3c:	e8 81 06 00 00       	call   801053c2 <argint>
80104d41:	85 c0                	test   %eax,%eax
80104d43:	79 07                	jns    80104d4c <sys_change_seed+0x4a>
	{
		return -1;
80104d45:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104d4a:	eb 30                	jmp    80104d7c <sys_change_seed+0x7a>
	}	

	if(argint(1, &set) < 0)
80104d4c:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104d4f:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d53:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80104d5a:	e8 63 06 00 00       	call   801053c2 <argint>
80104d5f:	85 c0                	test   %eax,%eax
80104d61:	79 07                	jns    80104d6a <sys_change_seed+0x68>
	{
		return -1;
80104d63:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104d68:	eb 12                	jmp    80104d7c <sys_change_seed+0x7a>
	}

	zrng[stream] = set;
80104d6a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d6d:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104d70:	89 14 85 40 b0 10 80 	mov    %edx,-0x7fef4fc0(,%eax,4)
...
80104d81:	83 ec 28             	sub    $0x28,%esp
	int stream;
	if(argint(0, &stream) < 0)
80104d84:	8d 45 f4             	lea    -0xc(%ebp),%eax
80104d87:	89 44 24 04          	mov    %eax,0x4(%esp)
80104d8b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80104d92:	e8 2b 06 00 00       	call   801053c2 <argint>
80104d97:	85 c0                	test   %eax,%eax
80104d99:	79 07                	jns    80104da2 <sys_actual_seed+0x24>
	{
		return -1;
80104d9b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104da0:	eb 0a                	jmp    80104dac <sys_actual_seed+0x2e>
	}
	return (int)zrng[stream];
80104da2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104da5:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
} 
80104dac:	c9                   	leave  
80104dad:	c3                   	ret    
	...
...
80104db4:	83 ec 10             	sub    $0x10,%esp
  uint eflags;
  asm volatile("pushfl; popl %0" : "=r" (eflags));
80104db7:	9c                   	pushf  
80104db8:	5b                   	pop    %ebx
80104db9:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return eflags;
80104dbc:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80104de8:	89 c3                	mov    %eax,%ebx
80104dea:	89 5d f8             	mov    %ebx,-0x8(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
80104ded:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
80104dfc:	8b 55 0c             	mov    0xc(%ebp),%edx
80104dff:	89 50 04             	mov    %edx,0x4(%eax)
  lk->locked = 0;
80104e02:	8b 45 08             	mov    0x8(%ebp),%eax
80104e05:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  lk->cpu = 0;
80104e0b:	8b 45 08             	mov    0x8(%ebp),%eax
80104e0e:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80104e15:	5d                   	pop    %ebp
80104e16:	c3                   	ret    
...
80104e1d:	e8 3d 01 00 00       	call   80104f5f <pushcli>
  if(holding(lk))
80104e22:	8b 45 08             	mov    0x8(%ebp),%eax
80104e25:	89 04 24             	mov    %eax,(%esp)
80104e28:	e8 08 01 00 00       	call   80104f35 <holding>
80104e2d:	85 c0                	test   %eax,%eax
80104e2f:	74 0c                	je     80104e3d <acquire+0x26>
    panic("acquire");
80104e31:	c7 04 24 78 87 10 80 	movl   $0x80108778,(%esp)
80104e38:	e8 00 b7 ff ff       	call   8010053d <panic>
...
80104e41:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80104e48:	00 
80104e49:	89 04 24             	mov    %eax,(%esp)
80104e4c:	e8 80 ff ff ff       	call   80104dd1 <xchg>
80104e51:	85 c0                	test   %eax,%eax
80104e53:	75 e9                	jne    80104e3e <acquire+0x27>
    ;
...
80104e5f:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80104e62:	8b 45 08             	mov    0x8(%ebp),%eax
80104e65:	83 c0 0c             	add    $0xc,%eax
80104e68:	89 44 24 04          	mov    %eax,0x4(%esp)
80104e6c:	8d 45 08             	lea    0x8(%ebp),%eax
80104e6f:	89 04 24             	mov    %eax,(%esp)
80104e72:	e8 51 00 00 00       	call   80104ec8 <getcallerpcs>
}
80104e77:	c9                   	leave  
80104e78:	c3                   	ret    
...
80104e85:	e8 ab 00 00 00       	call   80104f35 <holding>
80104e8a:	85 c0                	test   %eax,%eax
80104e8c:	75 0c                	jne    80104e9a <release+0x21>
    panic("release");
80104e8e:	c7 04 24 80 87 10 80 	movl   $0x80108780,(%esp)
80104e95:	e8 a3 b6 ff ff       	call   8010053d <panic>

  lk->pcs[0] = 0;
80104e9a:	8b 45 08             	mov    0x8(%ebp),%eax
80104e9d:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
80104ea4:	8b 45 08             	mov    0x8(%ebp),%eax
80104ea7:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
80104eb1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104eb8:	00 
80104eb9:	89 04 24             	mov    %eax,(%esp)
80104ebc:	e8 10 ff ff ff       	call   80104dd1 <xchg>

  popcli();
80104ec1:	e8 e1 00 00 00       	call   80104fa7 <popcli>
}
80104ec6:	c9                   	leave  
80104ec7:	c3                   	ret    

80104ec8 <getcallerpcs>:
...
80104ecb:	83 ec 10             	sub    $0x10,%esp
  uint *ebp;
  int i;
  
  ebp = (uint*)v - 2;
80104ece:	8b 45 08             	mov    0x8(%ebp),%eax
80104ed1:	83 e8 08             	sub    $0x8,%eax
80104ed4:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
80104ed7:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80104ede:	eb 32                	jmp    80104f12 <getcallerpcs+0x4a>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104ee0:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80104ee4:	74 47                	je     80104f2d <getcallerpcs+0x65>
80104ee6:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80104eed:	76 3e                	jbe    80104f2d <getcallerpcs+0x65>
80104eef:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80104ef3:	74 38                	je     80104f2d <getcallerpcs+0x65>
      break;
    pcs[i] = ebp[1];     // saved %eip
80104ef5:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104ef8:	c1 e0 02             	shl    $0x2,%eax
80104efb:	03 45 0c             	add    0xc(%ebp),%eax
80104efe:	8b 55 fc             	mov    -0x4(%ebp),%edx
80104f01:	8b 52 04             	mov    0x4(%edx),%edx
80104f04:	89 10                	mov    %edx,(%eax)
...
80104f16:	7e c8                	jle    80104ee0 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104f18:	eb 13                	jmp    80104f2d <getcallerpcs+0x65>
    pcs[i] = 0;
80104f1a:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104f1d:	c1 e0 02             	shl    $0x2,%eax
80104f20:	03 45 0c             	add    0xc(%ebp),%eax
80104f23:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
...
80104f31:	7e e7                	jle    80104f1a <getcallerpcs+0x52>
    pcs[i] = 0;
}
80104f33:	c9                   	leave  
80104f34:	c3                   	ret    
...
80104f3f:	74 17                	je     80104f58 <holding+0x23>
80104f41:	8b 45 08             	mov    0x8(%ebp),%eax
80104f44:	8b 50 08             	mov    0x8(%eax),%edx
80104f47:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104f4d:	39 c2                	cmp    %eax,%edx
80104f4f:	75 07                	jne    80104f58 <holding+0x23>
80104f51:	b8 01 00 00 00       	mov    $0x1,%eax
80104f56:	eb 05                	jmp    80104f5d <holding+0x28>
...
80104f62:	83 ec 10             	sub    $0x10,%esp
  int eflags;
  
  eflags = readeflags();
80104f65:	e8 46 fe ff ff       	call   80104db0 <readeflags>
80104f6a:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80104f6d:	e8 53 fe ff ff       	call   80104dc5 <cli>
  if(cpu->ncli++ == 0)
80104f72:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104f78:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80104f7e:	85 d2                	test   %edx,%edx
80104f80:	0f 94 c1             	sete   %cl
80104f83:	83 c2 01             	add    $0x1,%edx
80104f86:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80104f8c:	84 c9                	test   %cl,%cl
80104f8e:	74 15                	je     80104fa5 <pushcli+0x46>
    cpu->intena = eflags & FL_IF;
80104f90:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104f96:	8b 55 fc             	mov    -0x4(%ebp),%edx
80104f99:	81 e2 00 02 00 00    	and    $0x200,%edx
80104f9f:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104fa5:	c9                   	leave  
80104fa6:	c3                   	ret    
...
80104faa:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
80104fad:	e8 fe fd ff ff       	call   80104db0 <readeflags>
80104fb2:	25 00 02 00 00       	and    $0x200,%eax
80104fb7:	85 c0                	test   %eax,%eax
80104fb9:	74 0c                	je     80104fc7 <popcli+0x20>
    panic("popcli - interruptible");
80104fbb:	c7 04 24 88 87 10 80 	movl   $0x80108788,(%esp)
80104fc2:	e8 76 b5 ff ff       	call   8010053d <panic>
  if(--cpu->ncli < 0)
80104fc7:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104fcd:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80104fd3:	83 ea 01             	sub    $0x1,%edx
80104fd6:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
80104fdc:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104fe2:	85 c0                	test   %eax,%eax
80104fe4:	79 0c                	jns    80104ff2 <popcli+0x4b>
    panic("popcli");
80104fe6:	c7 04 24 9f 87 10 80 	movl   $0x8010879f,(%esp)
80104fed:	e8 4b b5 ff ff       	call   8010053d <panic>
  if(cpu->ncli == 0 && cpu->intena)
80104ff2:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104ff8:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104ffe:	85 c0                	test   %eax,%eax
80105000:	75 15                	jne    80105017 <popcli+0x70>
80105002:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105008:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
8010500e:	85 c0                	test   %eax,%eax
80105010:	74 05                	je     80105017 <popcli+0x70>
    sti();
80105012:	e8 b4 fd ff ff       	call   80104dcb <sti>
}
80105017:	c9                   	leave  
80105018:	c3                   	ret    
80105019:	00 00                	add    %al,(%eax)
	...
...
80105030:	fc                   	cld    
80105031:	f3 aa                	rep stos %al,%es:(%edi)
...
80105049:	8b 55 10             	mov    0x10(%ebp),%edx
8010504c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010504f:	89 cb                	mov    %ecx,%ebx
80105051:	89 df                	mov    %ebx,%edi
80105053:	89 d1                	mov    %edx,%ecx
80105055:	fc                   	cld    
80105056:	f3 ab                	rep stos %eax,%es:(%edi)
80105058:	89 ca                	mov    %ecx,%edx
8010505a:	89 fb                	mov    %edi,%ebx
8010505c:	89 5d 08             	mov    %ebx,0x8(%ebp)
8010505f:	89 55 10             	mov    %edx,0x10(%ebp)
               "=D" (addr), "=c" (cnt) :
               "0" (addr), "1" (cnt), "a" (data) :
               "memory", "cc");
}
...
8010506f:	83 e0 03             	and    $0x3,%eax
80105072:	85 c0                	test   %eax,%eax
80105074:	75 49                	jne    801050bf <memset+0x59>
80105076:	8b 45 10             	mov    0x10(%ebp),%eax
80105079:	83 e0 03             	and    $0x3,%eax
8010507c:	85 c0                	test   %eax,%eax
8010507e:	75 3f                	jne    801050bf <memset+0x59>
    c &= 0xFF;
80105080:	81 65 0c ff 00 00 00 	andl   $0xff,0xc(%ebp)
    stosl(dst, (c<<24)|(c<<16)|(c<<8)|c, n/4);
80105087:	8b 45 10             	mov    0x10(%ebp),%eax
8010508a:	c1 e8 02             	shr    $0x2,%eax
8010508d:	89 c2                	mov    %eax,%edx
8010508f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105092:	89 c1                	mov    %eax,%ecx
80105094:	c1 e1 18             	shl    $0x18,%ecx
80105097:	8b 45 0c             	mov    0xc(%ebp),%eax
8010509a:	c1 e0 10             	shl    $0x10,%eax
8010509d:	09 c1                	or     %eax,%ecx
8010509f:	8b 45 0c             	mov    0xc(%ebp),%eax
801050a2:	c1 e0 08             	shl    $0x8,%eax
801050a5:	09 c8                	or     %ecx,%eax
801050a7:	0b 45 0c             	or     0xc(%ebp),%eax
801050aa:	89 54 24 08          	mov    %edx,0x8(%esp)
801050ae:	89 44 24 04          	mov    %eax,0x4(%esp)
801050b2:	8b 45 08             	mov    0x8(%ebp),%eax
801050b5:	89 04 24             	mov    %eax,(%esp)
801050b8:	e8 84 ff ff ff       	call   80105041 <stosl>
801050bd:	eb 19                	jmp    801050d8 <memset+0x72>
  } else
    stosb(dst, c, n);
...
801050d3:	e8 44 ff ff ff       	call   8010501c <stosb>
  return dst;
...
801050ec:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
801050ef:	eb 32                	jmp    80105123 <memcmp+0x46>
    if(*s1 != *s2)
801050f1:	8b 45 fc             	mov    -0x4(%ebp),%eax
801050f4:	0f b6 10             	movzbl (%eax),%edx
801050f7:	8b 45 f8             	mov    -0x8(%ebp),%eax
801050fa:	0f b6 00             	movzbl (%eax),%eax
801050fd:	38 c2                	cmp    %al,%dl
801050ff:	74 1a                	je     8010511b <memcmp+0x3e>
      return *s1 - *s2;
80105101:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105104:	0f b6 00             	movzbl (%eax),%eax
80105107:	0f b6 d0             	movzbl %al,%edx
8010510a:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010510d:	0f b6 00             	movzbl (%eax),%eax
80105110:	0f b6 c0             	movzbl %al,%eax
80105113:	89 d1                	mov    %edx,%ecx
80105115:	29 c1                	sub    %eax,%ecx
80105117:	89 c8                	mov    %ecx,%eax
80105119:	eb 1c                	jmp    80105137 <memcmp+0x5a>
    s1++, s2++;
8010511b:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
8010511f:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
{
  const uchar *s1, *s2;
...
80105127:	0f 95 c0             	setne  %al
8010512a:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010512e:	84 c0                	test   %al,%al
80105130:	75 bf                	jne    801050f1 <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
80105151:	73 54                	jae    801051a7 <memmove+0x6e>
80105153:	8b 45 10             	mov    0x10(%ebp),%eax
80105156:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105159:	01 d0                	add    %edx,%eax
8010515b:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010515e:	76 47                	jbe    801051a7 <memmove+0x6e>
    s += n;
80105160:	8b 45 10             	mov    0x10(%ebp),%eax
80105163:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
80105166:	8b 45 10             	mov    0x10(%ebp),%eax
80105169:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
8010516c:	eb 13                	jmp    80105181 <memmove+0x48>
      *--d = *--s;
8010516e:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
80105172:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
80105176:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105179:	0f b6 10             	movzbl (%eax),%edx
8010517c:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010517f:	88 10                	mov    %dl,(%eax)
  s = src;
  d = dst;
  if(s < d && s + n > d){
    s += n;
...
80105185:	0f 95 c0             	setne  %al
80105188:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010518c:	84 c0                	test   %al,%al
8010518e:	75 de                	jne    8010516e <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
80105190:	eb 25                	jmp    801051b7 <memmove+0x7e>
    d += n;
    while(n-- > 0)
      *--d = *--s;
  } else
...
801051a1:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801051a5:	eb 01                	jmp    801051a8 <memmove+0x6f>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
...
801051ac:	0f 95 c0             	setne  %al
801051af:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801051b3:	84 c0                	test   %al,%al
801051b5:	75 db                	jne    80105192 <memmove+0x59>
      *d++ = *s++;
...
801051c5:	89 44 24 08          	mov    %eax,0x8(%esp)
...
801051d6:	e8 5e ff ff ff       	call   80105139 <memmove>
}
801051db:	c9                   	leave  
801051dc:	c3                   	ret    
...
801051de:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
801051e0:	eb 0c                	jmp    801051ee <strncmp+0x11>
    n--, p++, q++;
801051e2:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801051e6:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801051ea:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
801051f2:	74 1a                	je     8010520e <strncmp+0x31>
801051f4:	8b 45 08             	mov    0x8(%ebp),%eax
801051f7:	0f b6 00             	movzbl (%eax),%eax
801051fa:	84 c0                	test   %al,%al
801051fc:	74 10                	je     8010520e <strncmp+0x31>
801051fe:	8b 45 08             	mov    0x8(%ebp),%eax
80105201:	0f b6 10             	movzbl (%eax),%edx
80105204:	8b 45 0c             	mov    0xc(%ebp),%eax
80105207:	0f b6 00             	movzbl (%eax),%eax
8010520a:	38 c2                	cmp    %al,%dl
8010520c:	74 d4                	je     801051e2 <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
8010520e:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105212:	75 07                	jne    8010521b <strncmp+0x3e>
    return 0;
80105214:	b8 00 00 00 00       	mov    $0x0,%eax
80105219:	eb 18                	jmp    80105233 <strncmp+0x56>
  return (uchar)*p - (uchar)*q;
8010521b:	8b 45 08             	mov    0x8(%ebp),%eax
8010521e:	0f b6 00             	movzbl (%eax),%eax
80105221:	0f b6 d0             	movzbl %al,%edx
80105224:	8b 45 0c             	mov    0xc(%ebp),%eax
80105227:	0f b6 00             	movzbl (%eax),%eax
8010522a:	0f b6 c0             	movzbl %al,%eax
8010522d:	89 d1                	mov    %edx,%ecx
8010522f:	29 c1                	sub    %eax,%ecx
80105231:	89 c8                	mov    %ecx,%eax
}
80105233:	5d                   	pop    %ebp
80105234:	c3                   	ret    
...
8010523e:	89 45 fc             	mov    %eax,-0x4(%ebp)
  while(n-- > 0 && (*s++ = *t++) != 0)
80105241:	90                   	nop
80105242:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105246:	0f 9f c0             	setg   %al
80105249:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010524d:	84 c0                	test   %al,%al
8010524f:	74 30                	je     80105281 <strncpy+0x4c>
80105251:	8b 45 0c             	mov    0xc(%ebp),%eax
80105254:	0f b6 10             	movzbl (%eax),%edx
80105257:	8b 45 08             	mov    0x8(%ebp),%eax
8010525a:	88 10                	mov    %dl,(%eax)
8010525c:	8b 45 08             	mov    0x8(%ebp),%eax
8010525f:	0f b6 00             	movzbl (%eax),%eax
80105262:	84 c0                	test   %al,%al
80105264:	0f 95 c0             	setne  %al
80105267:	83 45 08 01          	addl   $0x1,0x8(%ebp)
8010526b:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
8010526f:	84 c0                	test   %al,%al
80105271:	75 cf                	jne    80105242 <strncpy+0xd>
    ;
  while(n-- > 0)
80105273:	eb 0c                	jmp    80105281 <strncpy+0x4c>
    *s++ = 0;
80105275:	8b 45 08             	mov    0x8(%ebp),%eax
80105278:	c6 00 00             	movb   $0x0,(%eax)
8010527b:	83 45 08 01          	addl   $0x1,0x8(%ebp)
8010527f:	eb 01                	jmp    80105282 <strncpy+0x4d>
  char *os;
  ...
  while(n-- > 0)
80105281:	90                   	nop
80105282:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105286:	0f 9f c0             	setg   %al
80105289:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
8010528d:	84 c0                	test   %al,%al
8010528f:	75 e4                	jne    80105275 <strncpy+0x40>
    *s++ = 0;
  return os;
...
801052ab:	eb 35                	jmp    801052e2 <safestrcpy+0x4c>
  while(--n > 0 && (*s++ = *t++) != 0)
801052ad:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801052b1:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801052b5:	7e 22                	jle    801052d9 <safestrcpy+0x43>
...
801052ca:	0f 95 c0             	setne  %al
801052cd:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801052d1:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
801052d5:	84 c0                	test   %al,%al
801052d7:	75 d4                	jne    801052ad <safestrcpy+0x17>
    ;
  *s = 0;
...
801052fa:	03 45 08             	add    0x8(%ebp),%eax
801052fd:	0f b6 00             	movzbl (%eax),%eax
80105300:	84 c0                	test   %al,%al
80105302:	75 ef                	jne    801052f3 <strlen+0xf>
    ;
  return n;
...
swtch:
  movl 4(%esp), %eax
8010530c:	8b 44 24 04          	mov    0x4(%esp),%eax
  movl 8(%esp), %edx
80105310:	8b 54 24 08          	mov    0x8(%esp),%edx
...
80105317:	57                   	push   %edi
  ...
  # Switch stacks
  movl %esp, (%eax)
80105318:	89 20                	mov    %esp,(%eax)
  movl %edx, %esp
8010531a:	89 d4                	mov    %edx,%esp
...
80105332:	76 12                	jbe    80105346 <fetchint+0x22>
...
80105344:	76 07                	jbe    8010534d <fetchint+0x29>
    return -1;
80105346:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010534b:	eb 0f                	jmp    8010535c <fetchint+0x38>
  *ip = *(int*)(addr);
8010534d:	8b 45 08             	mov    0x8(%ebp),%eax
80105350:	8b 10                	mov    (%eax),%edx
...
8010536c:	3b 45 08             	cmp    0x8(%ebp),%eax
8010536f:	77 07                	ja     80105378 <fetchstr+0x1a>
    return -1;
80105371:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105376:	eb 48                	jmp    801053c0 <fetchstr+0x62>
  *pp = (char*)addr;
80105378:	8b 55 08             	mov    0x8(%ebp),%edx
8010537b:	8b 45 0c             	mov    0xc(%ebp),%eax
8010537e:	89 10                	mov    %edx,(%eax)
  ep = (char*)proc->sz;
80105380:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105386:	8b 00                	mov    (%eax),%eax
...
80105393:	eb 1e                	jmp    801053b3 <fetchstr+0x55>
    if(*s == 0)
80105395:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105398:	0f b6 00             	movzbl (%eax),%eax
8010539b:	84 c0                	test   %al,%al
8010539d:	75 10                	jne    801053af <fetchstr+0x51>
      return s - *pp;
8010539f:	8b 55 fc             	mov    -0x4(%ebp),%edx
801053a2:	8b 45 0c             	mov    0xc(%ebp),%eax
801053a5:	8b 00                	mov    (%eax),%eax
801053a7:	89 d1                	mov    %edx,%ecx
801053a9:	29 c1                	sub    %eax,%ecx
801053ab:	89 c8                	mov    %ecx,%eax
801053ad:	eb 11                	jmp    801053c0 <fetchstr+0x62>
  ...
  *pp = (char*)addr;
  ep = (char*)proc->sz;
  for(s = *pp; s < ep; s++)
801053af:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801053b3:	8b 45 fc             	mov    -0x4(%ebp),%eax
801053b6:	3b 45 f8             	cmp    -0x8(%ebp),%eax
801053b9:	72 da                	jb     80105395 <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
80105420:	39 c2                	cmp    %eax,%edx
80105422:	73 16                	jae    8010543a <argptr+0x4a>
80105424:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105427:	89 c2                	mov    %eax,%edx
80105429:	8b 45 10             	mov    0x10(%ebp),%eax
8010542c:	01 c2                	add    %eax,%edx
8010542e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105434:	8b 00                	mov    (%eax),%eax
80105436:	39 c2                	cmp    %eax,%edx
80105438:	76 07                	jbe    80105441 <argptr+0x51>
    return -1;
8010543a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010543f:	eb 0f                	jmp    80105450 <argptr+0x60>
  *pp = (char*)i;
80105441:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105444:	89 c2                	mov    %eax,%edx
80105446:	8b 45 0c             	mov    0xc(%ebp),%eax
80105449:	89 10                	mov    %edx,(%eax)
  return 0;
8010544b:	b8 00 00 00 00       	mov    $0x0,%eax
}
80105450:	c9                   	leave  
80105451:	c3                   	ret    
...
80105455:	83 ec 18             	sub    $0x18,%esp
  int addr;
  if(argint(n, &addr) < 0)
80105458:	8d 45 fc             	lea    -0x4(%ebp),%eax
8010545b:	89 44 24 04          	mov    %eax,0x4(%esp)
8010545f:	8b 45 08             	mov    0x8(%ebp),%eax
80105462:	89 04 24             	mov    %eax,(%esp)
80105465:	e8 58 ff ff ff       	call   801053c2 <argint>
8010546a:	85 c0                	test   %eax,%eax
8010546c:	79 07                	jns    80105475 <argstr+0x23>
    return -1;
8010546e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105473:	eb 12                	jmp    80105487 <argstr+0x35>
  return fetchstr(addr, pp);
80105475:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105478:	8b 55 0c             	mov    0xc(%ebp),%edx
8010547b:	89 54 24 04          	mov    %edx,0x4(%esp)
8010547f:	89 04 24             	mov    %eax,(%esp)
80105482:	e8 d7 fe ff ff       	call   8010535e <fetchstr>
}
80105487:	c9                   	leave  
80105488:	c3                   	ret    
...
80105496:	8b 40 18             	mov    0x18(%eax),%eax
80105499:	8b 40 1c             	mov    0x1c(%eax),%eax
8010549c:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
8010549f:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801054a3:	7e 30                	jle    801054d5 <syscall+0x4c>
801054a5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054a8:	83 f8 19             	cmp    $0x19,%eax
801054ab:	77 28                	ja     801054d5 <syscall+0x4c>
801054ad:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054b0:	8b 04 85 e0 b1 10 80 	mov    -0x7fef4e20(,%eax,4),%eax
801054b7:	85 c0                	test   %eax,%eax
801054b9:	74 1a                	je     801054d5 <syscall+0x4c>
    proc->tf->eax = syscalls[num]();
801054bb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801054c1:	8b 58 18             	mov    0x18(%eax),%ebx
801054c4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801054c7:	8b 04 85 e0 b1 10 80 	mov    -0x7fef4e20(,%eax,4),%eax
801054ce:	ff d0                	call   *%eax
801054d0:	89 43 1c             	mov    %eax,0x1c(%ebx)
801054d3:	eb 3d                	jmp    80105512 <syscall+0x89>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
801054d5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801054db:	8d 48 6c             	lea    0x6c(%eax),%ecx
801054de:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
...
801054ea:	89 54 24 0c          	mov    %edx,0xc(%esp)
801054ee:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801054f2:	89 44 24 04          	mov    %eax,0x4(%esp)
801054f6:	c7 04 24 a6 87 10 80 	movl   $0x801087a6,(%esp)
801054fd:	e8 9f ae ff ff       	call   801003a1 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
80105502:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105508:	8b 40 18             	mov    0x18(%eax),%eax
8010550b:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
80105512:	83 c4 24             	add    $0x24,%esp
80105515:	5b                   	pop    %ebx
80105516:	5d                   	pop    %ebp
80105517:	c3                   	ret    
...
80105561:	75 07                	jne    8010556a <argfd+0x52>
    return -1;
80105563:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105568:	eb 21                	jmp    8010558b <argfd+0x73>
  if(pfd)
8010556a:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
8010556e:	74 08                	je     80105578 <argfd+0x60>
    *pfd = fd;
80105570:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105573:	8b 45 0c             	mov    0xc(%ebp),%eax
80105576:	89 10                	mov    %edx,(%eax)
  if(pf)
80105578:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
8010557c:	74 08                	je     80105586 <argfd+0x6e>
    *pf = f;
8010557e:	8b 45 10             	mov    0x10(%ebp),%eax
80105581:	8b 55 f4             	mov    -0xc(%ebp),%edx
...
fdalloc(struct file *f)
{
  ...
  for(fd = 0; fd < NOFILE; fd++){
801055c8:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
801055cc:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
801055d0:	7e ca                	jle    8010559c <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
8010560b:	e8 7d ff ff ff       	call   8010558d <fdalloc>
...
80105626:	e8 49 b9 ff ff       	call   80100f74 <filedup>
  return fd;
...
80105663:	e8 5a fd ff ff       	call   801053c2 <argint>
...
80105681:	e8 6a fd ff ff       	call   801053f0 <argptr>
...
801056a5:	e8 37 ba ff ff       	call   801010e1 <fileread>
}
801056aa:	c9                   	leave  
801056ab:	c3                   	ret    
...
801056df:	e8 de fc ff ff       	call   801053c2 <argint>
...
801056fd:	e8 ee fc ff ff       	call   801053f0 <argptr>
...
80105721:	e8 77 ba ff ff       	call   8010119d <filewrite>
}
80105726:	c9                   	leave  
80105727:	c3                   	ret    
...
80105751:	eb 24                	jmp    80105777 <sys_close+0x4f>
  proc->ofile[fd] = 0;
80105753:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105759:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010575c:	83 c2 08             	add    $0x8,%edx
8010575f:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80105766:	00 
  fileclose(f);
80105767:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010576a:	89 04 24             	mov    %eax,(%esp)
8010576d:	e8 4a b8 ff ff       	call   80100fbc <fileclose>
  return 0;
80105772:	b8 00 00 00 00       	mov    $0x0,%eax
}
80105777:	c9                   	leave  
80105778:	c3                   	ret    
...
80105795:	e8 7e fd ff ff       	call   80105518 <argfd>
8010579a:	85 c0                	test   %eax,%eax
8010579c:	78 1f                	js     801057bd <sys_fstat+0x44>
8010579e:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
801057a5:	00 
801057a6:	8d 45 f0             	lea    -0x10(%ebp),%eax
801057a9:	89 44 24 04          	mov    %eax,0x4(%esp)
801057ad:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801057b4:	e8 37 fc ff ff       	call   801053f0 <argptr>
801057b9:	85 c0                	test   %eax,%eax
801057bb:	79 07                	jns    801057c4 <sys_fstat+0x4b>
    return -1;
801057bd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057c2:	eb 12                	jmp    801057d6 <sys_fstat+0x5d>
  return filestat(f, st);
801057c4:	8b 55 f0             	mov    -0x10(%ebp),%edx
801057c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057ca:	89 54 24 04          	mov    %edx,0x4(%esp)
801057ce:	89 04 24             	mov    %eax,(%esp)
801057d1:	e8 bc b8 ff ff       	call   80101092 <filestat>
}
801057d6:	c9                   	leave  
801057d7:	c3                   	ret    
...
801057de:	8d 45 d8             	lea    -0x28(%ebp),%eax
801057e1:	89 44 24 04          	mov    %eax,0x4(%esp)
801057e5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801057ec:	e8 61 fc ff ff       	call   80105452 <argstr>
801057f1:	85 c0                	test   %eax,%eax
801057f3:	78 17                	js     8010580c <sys_link+0x34>
801057f5:	8d 45 dc             	lea    -0x24(%ebp),%eax
801057f8:	89 44 24 04          	mov    %eax,0x4(%esp)
801057fc:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105803:	e8 4a fc ff ff       	call   80105452 <argstr>
80105808:	85 c0                	test   %eax,%eax
8010580a:	79 0a                	jns    80105816 <sys_link+0x3e>
    return -1;
8010580c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105811:	e9 3c 01 00 00       	jmp    80105952 <sys_link+0x17a>
  if((ip = namei(old)) == 0)
80105816:	8b 45 d8             	mov    -0x28(%ebp),%eax
80105819:	89 04 24             	mov    %eax,(%esp)
8010581c:	e8 e1 cb ff ff       	call   80102402 <namei>
80105821:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105824:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105828:	75 0a                	jne    80105834 <sys_link+0x5c>
    return -1;
8010582a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010582f:	e9 1e 01 00 00       	jmp    80105952 <sys_link+0x17a>

  begin_trans();
80105834:	e8 dc d9 ff ff       	call   80103215 <begin_trans>

  ilock(ip);
80105839:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010583c:	89 04 24             	mov    %eax,(%esp)
8010583f:	e8 1c c0 ff ff       	call   80101860 <ilock>
  if(ip->type == T_DIR){
80105844:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105847:	0f b7 40 10          	movzwl 0x10(%eax),%eax
8010584b:	66 83 f8 01          	cmp    $0x1,%ax
8010584f:	75 1a                	jne    8010586b <sys_link+0x93>
    iunlockput(ip);
80105851:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105854:	89 04 24             	mov    %eax,(%esp)
80105857:	e8 88 c2 ff ff       	call   80101ae4 <iunlockput>
    commit_trans();
8010585c:	e8 fd d9 ff ff       	call   8010325e <commit_trans>
    return -1;
80105861:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105866:	e9 e7 00 00 00       	jmp    80105952 <sys_link+0x17a>
  }

  ip->nlink++;
8010586b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010586e:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105872:	8d 50 01             	lea    0x1(%eax),%edx
80105875:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105878:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
8010587c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010587f:	89 04 24             	mov    %eax,(%esp)
80105882:	e8 1d be ff ff       	call   801016a4 <iupdate>
  iunlock(ip);
80105887:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010588a:	89 04 24             	mov    %eax,(%esp)
8010588d:	e8 1c c1 ff ff       	call   801019ae <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80105892:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105895:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105898:	89 54 24 04          	mov    %edx,0x4(%esp)
8010589c:	89 04 24             	mov    %eax,(%esp)
8010589f:	e8 80 cb ff ff       	call   80102424 <nameiparent>
801058a4:	89 45 f0             	mov    %eax,-0x10(%ebp)
801058a7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801058ab:	74 68                	je     80105915 <sys_link+0x13d>
    goto bad;
  ilock(dp);
801058ad:	8b 45 f0             	mov    -0x10(%ebp),%eax
801058b0:	89 04 24             	mov    %eax,(%esp)
801058b3:	e8 a8 bf ff ff       	call   80101860 <ilock>
...
801058c4:	75 20                	jne    801058e6 <sys_link+0x10e>
...
801058dd:	e8 5f c8 ff ff       	call   80102141 <dirlink>
801058e2:	85 c0                	test   %eax,%eax
801058e4:	79 0d                	jns    801058f3 <sys_link+0x11b>
    iunlockput(dp);
801058e6:	8b 45 f0             	mov    -0x10(%ebp),%eax
801058e9:	89 04 24             	mov    %eax,(%esp)
801058ec:	e8 f3 c1 ff ff       	call   80101ae4 <iunlockput>
    goto bad;
801058f1:	eb 23                	jmp    80105916 <sys_link+0x13e>
  }
  iunlockput(dp);
801058f3:	8b 45 f0             	mov    -0x10(%ebp),%eax
801058f6:	89 04 24             	mov    %eax,(%esp)
801058f9:	e8 e6 c1 ff ff       	call   80101ae4 <iunlockput>
  iput(ip);
801058fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105901:	89 04 24             	mov    %eax,(%esp)
80105904:	e8 0a c1 ff ff       	call   80101a13 <iput>

  commit_trans();
80105909:	e8 50 d9 ff ff       	call   8010325e <commit_trans>

  return 0;
8010590e:	b8 00 00 00 00       	mov    $0x0,%eax
80105913:	eb 3d                	jmp    80105952 <sys_link+0x17a>
  ip->nlink++;
  iupdate(ip);
  iunlock(ip);
...
8010591c:	e8 3f bf ff ff       	call   80101860 <ilock>
  ip->nlink--;
...
80105938:	e8 67 bd ff ff       	call   801016a4 <iupdate>
  iunlockput(ip);
8010593d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105940:	89 04 24             	mov    %eax,(%esp)
80105943:	e8 9c c1 ff ff       	call   80101ae4 <iunlockput>
  commit_trans();
80105948:	e8 11 d9 ff ff       	call   8010325e <commit_trans>
  return -1;
...
80105961:	eb 4b                	jmp    801059ae <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
8010597f:	e8 d2 c3 ff ff       	call   80101d56 <readi>
80105984:	83 f8 10             	cmp    $0x10,%eax
80105987:	74 0c                	je     80105995 <isdirempty+0x41>
      panic("isdirempty: readi");
80105989:	c7 04 24 c2 87 10 80 	movl   $0x801087c2,(%esp)
80105990:	e8 a8 ab ff ff       	call   8010053d <panic>
    if(de.inum != 0)
80105995:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105999:	66 85 c0             	test   %ax,%ax
8010599c:	74 07                	je     801059a5 <isdirempty+0x51>
      return 0;
8010599e:	b8 00 00 00 00       	mov    $0x0,%eax
801059a3:	eb 1b                	jmp    801059c0 <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
801059a8:	83 c0 10             	add    $0x10,%eax
801059ab:	89 45 f4             	mov    %eax,-0xc(%ebp)
...
801059b9:	72 a8                	jb     80105963 <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
  ...
  return 1;
801059bb:	b8 01 00 00 00       	mov    $0x1,%eax
}
801059c0:	c9                   	leave  
801059c1:	c3                   	ret    
...
801059c5:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
801059c8:	8d 45 cc             	lea    -0x34(%ebp),%eax
801059cb:	89 44 24 04          	mov    %eax,0x4(%esp)
801059cf:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801059d6:	e8 77 fa ff ff       	call   80105452 <argstr>
801059db:	85 c0                	test   %eax,%eax
801059dd:	79 0a                	jns    801059e9 <sys_unlink+0x27>
    return -1;
801059df:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801059e4:	e9 aa 01 00 00       	jmp    80105b93 <sys_unlink+0x1d1>
...
801059f6:	e8 29 ca ff ff       	call   80102424 <nameiparent>
801059fb:	89 45 f4             	mov    %eax,-0xc(%ebp)
801059fe:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105a02:	75 0a                	jne    80105a0e <sys_unlink+0x4c>
    return -1;
80105a04:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105a09:	e9 85 01 00 00       	jmp    80105b93 <sys_unlink+0x1d1>

  begin_trans();
80105a0e:	e8 02 d8 ff ff       	call   80103215 <begin_trans>

  ilock(dp);
80105a13:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a16:	89 04 24             	mov    %eax,(%esp)
80105a19:	e8 42 be ff ff       	call   80101860 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105a1e:	c7 44 24 04 d4 87 10 	movl   $0x801087d4,0x4(%esp)
80105a25:	80 
80105a26:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105a29:	89 04 24             	mov    %eax,(%esp)
80105a2c:	e8 26 c6 ff ff       	call   80102057 <namecmp>
80105a31:	85 c0                	test   %eax,%eax
80105a33:	0f 84 45 01 00 00    	je     80105b7e <sys_unlink+0x1bc>
80105a39:	c7 44 24 04 d6 87 10 	movl   $0x801087d6,0x4(%esp)
80105a40:	80 
80105a41:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105a44:	89 04 24             	mov    %eax,(%esp)
80105a47:	e8 0b c6 ff ff       	call   80102057 <namecmp>
80105a4c:	85 c0                	test   %eax,%eax
80105a4e:	0f 84 2a 01 00 00    	je     80105b7e <sys_unlink+0x1bc>
    goto bad;
...
80105a68:	e8 0c c6 ff ff       	call   80102079 <dirlookup>
80105a6d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105a70:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105a74:	0f 84 03 01 00 00    	je     80105b7d <sys_unlink+0x1bb>
    goto bad;
  ilock(ip);
80105a7a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a7d:	89 04 24             	mov    %eax,(%esp)
80105a80:	e8 db bd ff ff       	call   80101860 <ilock>

  if(ip->nlink < 1)
80105a85:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105a88:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105a8c:	66 85 c0             	test   %ax,%ax
80105a8f:	7f 0c                	jg     80105a9d <sys_unlink+0xdb>
    panic("unlink: nlink < 1");
80105a91:	c7 04 24 d9 87 10 80 	movl   $0x801087d9,(%esp)
80105a98:	e8 a0 aa ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105a9d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105aa0:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105aa4:	66 83 f8 01          	cmp    $0x1,%ax
80105aa8:	75 1f                	jne    80105ac9 <sys_unlink+0x107>
80105aaa:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105aad:	89 04 24             	mov    %eax,(%esp)
80105ab0:	e8 9f fe ff ff       	call   80105954 <isdirempty>
80105ab5:	85 c0                	test   %eax,%eax
80105ab7:	75 10                	jne    80105ac9 <sys_unlink+0x107>
    iunlockput(ip);
80105ab9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105abc:	89 04 24             	mov    %eax,(%esp)
80105abf:	e8 20 c0 ff ff       	call   80101ae4 <iunlockput>
    goto bad;
80105ac4:	e9 b5 00 00 00       	jmp    80105b7e <sys_unlink+0x1bc>
  }
...
80105adf:	e8 82 f5 ff ff       	call   80105066 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80105b00:	e8 bc c3 ff ff       	call   80101ec1 <writei>
80105b05:	83 f8 10             	cmp    $0x10,%eax
80105b08:	74 0c                	je     80105b16 <sys_unlink+0x154>
    panic("unlink: writei");
80105b0a:	c7 04 24 eb 87 10 80 	movl   $0x801087eb,(%esp)
80105b11:	e8 27 aa ff ff       	call   8010053d <panic>
  if(ip->type == T_DIR){
80105b16:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b19:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105b1d:	66 83 f8 01          	cmp    $0x1,%ax
80105b21:	75 1c                	jne    80105b3f <sys_unlink+0x17d>
    dp->nlink--;
80105b23:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b26:	0f b7 40 16          	movzwl 0x16(%eax),%eax
...
80105b3a:	e8 65 bb ff ff       	call   801016a4 <iupdate>
  }
  iunlockput(dp);
80105b3f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b42:	89 04 24             	mov    %eax,(%esp)
80105b45:	e8 9a bf ff ff       	call   80101ae4 <iunlockput>

  ip->nlink--;
80105b4a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b4d:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105b51:	8d 50 ff             	lea    -0x1(%eax),%edx
80105b54:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b57:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105b5b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b5e:	89 04 24             	mov    %eax,(%esp)
80105b61:	e8 3e bb ff ff       	call   801016a4 <iupdate>
  iunlockput(ip);
80105b66:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b69:	89 04 24             	mov    %eax,(%esp)
80105b6c:	e8 73 bf ff ff       	call   80101ae4 <iunlockput>

  commit_trans();
80105b71:	e8 e8 d6 ff ff       	call   8010325e <commit_trans>

  return 0;
80105b76:	b8 00 00 00 00       	mov    $0x0,%eax
80105b7b:	eb 16                	jmp    80105b93 <sys_unlink+0x1d1>
  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
    goto bad;
...
80105b84:	e8 5b bf ff ff       	call   80101ae4 <iunlockput>
  commit_trans();
80105b89:	e8 d0 d6 ff ff       	call   8010325e <commit_trans>
  return -1;
...
80105b9b:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80105b9e:	8b 55 10             	mov    0x10(%ebp),%edx
80105ba1:	8b 45 14             	mov    0x14(%ebp),%eax
80105ba4:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80105ba8:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80105bac:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];
...
80105bbd:	e8 62 c8 ff ff       	call   80102424 <nameiparent>
80105bc2:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105bc5:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105bc9:	75 0a                	jne    80105bd5 <create+0x40>
    return 0;
80105bcb:	b8 00 00 00 00       	mov    $0x0,%eax
80105bd0:	e9 7e 01 00 00       	jmp    80105d53 <create+0x1be>
  ilock(dp);
80105bd5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bd8:	89 04 24             	mov    %eax,(%esp)
80105bdb:	e8 80 bc ff ff       	call   80101860 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80105be0:	8d 45 ec             	lea    -0x14(%ebp),%eax
...
80105bf4:	e8 80 c4 ff ff       	call   80102079 <dirlookup>
80105bf9:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105bfc:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105c00:	74 47                	je     80105c49 <create+0xb4>
    iunlockput(dp);
80105c02:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c05:	89 04 24             	mov    %eax,(%esp)
80105c08:	e8 d7 be ff ff       	call   80101ae4 <iunlockput>
    ilock(ip);
80105c0d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c10:	89 04 24             	mov    %eax,(%esp)
80105c13:	e8 48 bc ff ff       	call   80101860 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80105c18:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105c1d:	75 15                	jne    80105c34 <create+0x9f>
80105c1f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c22:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105c26:	66 83 f8 02          	cmp    $0x2,%ax
80105c2a:	75 08                	jne    80105c34 <create+0x9f>
      return ip;
80105c2c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c2f:	e9 1f 01 00 00       	jmp    80105d53 <create+0x1be>
    iunlockput(ip);
80105c34:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c37:	89 04 24             	mov    %eax,(%esp)
80105c3a:	e8 a5 be ff ff       	call   80101ae4 <iunlockput>
    return 0;
80105c3f:	b8 00 00 00 00       	mov    $0x0,%eax
80105c44:	e9 0a 01 00 00       	jmp    80105d53 <create+0x1be>
  }

  if((ip = ialloc(dp->dev, type)) == 0)
80105c49:	0f bf 55 d4          	movswl -0x2c(%ebp),%edx
80105c4d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c50:	8b 00                	mov    (%eax),%eax
80105c52:	89 54 24 04          	mov    %edx,0x4(%esp)
80105c56:	89 04 24             	mov    %eax,(%esp)
80105c59:	e8 69 b9 ff ff       	call   801015c7 <ialloc>
80105c5e:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105c61:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105c65:	75 0c                	jne    80105c73 <create+0xde>
    panic("create: ialloc");
80105c67:	c7 04 24 fa 87 10 80 	movl   $0x801087fa,(%esp)
80105c6e:	e8 ca a8 ff ff       	call   8010053d <panic>

  ilock(ip);
80105c73:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c76:	89 04 24             	mov    %eax,(%esp)
80105c79:	e8 e2 bb ff ff       	call   80101860 <ilock>
  ip->major = major;
80105c7e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c81:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80105c85:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80105c89:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c8c:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80105c90:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80105c94:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c97:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80105c9d:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ca0:	89 04 24             	mov    %eax,(%esp)
80105ca3:	e8 fc b9 ff ff       	call   801016a4 <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80105ca8:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80105cad:	75 6a                	jne    80105d19 <create+0x184>
    dp->nlink++;  // for ".."
...
80105cc6:	e8 d9 b9 ff ff       	call   801016a4 <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80105ccb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cce:	8b 40 04             	mov    0x4(%eax),%eax
80105cd1:	89 44 24 08          	mov    %eax,0x8(%esp)
80105cd5:	c7 44 24 04 d4 87 10 	movl   $0x801087d4,0x4(%esp)
80105cdc:	80 
80105cdd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ce0:	89 04 24             	mov    %eax,(%esp)
80105ce3:	e8 59 c4 ff ff       	call   80102141 <dirlink>
80105ce8:	85 c0                	test   %eax,%eax
80105cea:	78 21                	js     80105d0d <create+0x178>
80105cec:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cef:	8b 40 04             	mov    0x4(%eax),%eax
80105cf2:	89 44 24 08          	mov    %eax,0x8(%esp)
80105cf6:	c7 44 24 04 d6 87 10 	movl   $0x801087d6,0x4(%esp)
80105cfd:	80 
80105cfe:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d01:	89 04 24             	mov    %eax,(%esp)
80105d04:	e8 38 c4 ff ff       	call   80102141 <dirlink>
80105d09:	85 c0                	test   %eax,%eax
80105d0b:	79 0c                	jns    80105d19 <create+0x184>
      panic("create dots");
80105d0d:	c7 04 24 09 88 10 80 	movl   $0x80108809,(%esp)
80105d14:	e8 24 a8 ff ff       	call   8010053d <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
80105d19:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d1c:	8b 40 04             	mov    0x4(%eax),%eax
...
80105d30:	e8 0c c4 ff ff       	call   80102141 <dirlink>
80105d35:	85 c0                	test   %eax,%eax
80105d37:	79 0c                	jns    80105d45 <create+0x1b0>
    panic("create: dirlink");
80105d39:	c7 04 24 15 88 10 80 	movl   $0x80108815,(%esp)
80105d40:	e8 f8 a7 ff ff       	call   8010053d <panic>

  iunlockput(dp);
80105d45:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d48:	89 04 24             	mov    %eax,(%esp)
80105d4b:	e8 94 bd ff ff       	call   80101ae4 <iunlockput>
...
80105d58:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80105d69:	e8 e4 f6 ff ff       	call   80105452 <argstr>
80105d6e:	85 c0                	test   %eax,%eax
80105d70:	78 17                	js     80105d89 <sys_open+0x34>
80105d72:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105d75:	89 44 24 04          	mov    %eax,0x4(%esp)
80105d79:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105d80:	e8 3d f6 ff ff       	call   801053c2 <argint>
80105d85:	85 c0                	test   %eax,%eax
80105d87:	79 0a                	jns    80105d93 <sys_open+0x3e>
    return -1;
80105d89:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105d8e:	e9 46 01 00 00       	jmp    80105ed9 <sys_open+0x184>
  if(omode & O_CREATE){
80105d93:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105d96:	25 00 02 00 00       	and    $0x200,%eax
80105d9b:	85 c0                	test   %eax,%eax
80105d9d:	74 40                	je     80105ddf <sys_open+0x8a>
    begin_trans();
80105d9f:	e8 71 d4 ff ff       	call   80103215 <begin_trans>
    ip = create(path, T_FILE, 0, 0);
80105da4:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105da7:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105dae:	00 
80105daf:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105db6:	00 
80105db7:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80105dbe:	00 
80105dbf:	89 04 24             	mov    %eax,(%esp)
80105dc2:	e8 ce fd ff ff       	call   80105b95 <create>
80105dc7:	89 45 f4             	mov    %eax,-0xc(%ebp)
    commit_trans();
80105dca:	e8 8f d4 ff ff       	call   8010325e <commit_trans>
    if(ip == 0)
80105dcf:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105dd3:	75 5c                	jne    80105e31 <sys_open+0xdc>
      return -1;
80105dd5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105dda:	e9 fa 00 00 00       	jmp    80105ed9 <sys_open+0x184>
  } else {
    if((ip = namei(path)) == 0)
80105ddf:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105de2:	89 04 24             	mov    %eax,(%esp)
80105de5:	e8 18 c6 ff ff       	call   80102402 <namei>
80105dea:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105ded:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105df1:	75 0a                	jne    80105dfd <sys_open+0xa8>
      return -1;
80105df3:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105df8:	e9 dc 00 00 00       	jmp    80105ed9 <sys_open+0x184>
    ilock(ip);
80105dfd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e00:	89 04 24             	mov    %eax,(%esp)
80105e03:	e8 58 ba ff ff       	call   80101860 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105e08:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e0b:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105e0f:	66 83 f8 01          	cmp    $0x1,%ax
80105e13:	75 1c                	jne    80105e31 <sys_open+0xdc>
80105e15:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105e18:	85 c0                	test   %eax,%eax
80105e1a:	74 15                	je     80105e31 <sys_open+0xdc>
      iunlockput(ip);
80105e1c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e1f:	89 04 24             	mov    %eax,(%esp)
80105e22:	e8 bd bc ff ff       	call   80101ae4 <iunlockput>
      return -1;
80105e27:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e2c:	e9 a8 00 00 00       	jmp    80105ed9 <sys_open+0x184>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80105e31:	e8 de b0 ff ff       	call   80100f14 <filealloc>
80105e36:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105e39:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105e3d:	74 14                	je     80105e53 <sys_open+0xfe>
80105e3f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e42:	89 04 24             	mov    %eax,(%esp)
80105e45:	e8 43 f7 ff ff       	call   8010558d <fdalloc>
80105e4a:	89 45 ec             	mov    %eax,-0x14(%ebp)
80105e4d:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80105e51:	79 23                	jns    80105e76 <sys_open+0x121>
    if(f)
80105e53:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105e57:	74 0b                	je     80105e64 <sys_open+0x10f>
      fileclose(f);
80105e59:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e5c:	89 04 24             	mov    %eax,(%esp)
80105e5f:	e8 58 b1 ff ff       	call   80100fbc <fileclose>
    iunlockput(ip);
80105e64:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e67:	89 04 24             	mov    %eax,(%esp)
80105e6a:	e8 75 bc ff ff       	call   80101ae4 <iunlockput>
    return -1;
80105e6f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e74:	eb 63                	jmp    80105ed9 <sys_open+0x184>
  }
  iunlock(ip);
80105e76:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e79:	89 04 24             	mov    %eax,(%esp)
80105e7c:	e8 2d bb ff ff       	call   801019ae <iunlock>

  f->type = FD_INODE;
80105e81:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e84:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80105e8a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e8d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105e90:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80105e93:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105e96:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80105e9d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105ea0:	83 e0 01             	and    $0x1,%eax
80105ea3:	85 c0                	test   %eax,%eax
80105ea5:	0f 94 c2             	sete   %dl
80105ea8:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105eab:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105eae:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105eb1:	83 e0 01             	and    $0x1,%eax
80105eb4:	84 c0                	test   %al,%al
80105eb6:	75 0a                	jne    80105ec2 <sys_open+0x16d>
80105eb8:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105ebb:	83 e0 02             	and    $0x2,%eax
80105ebe:	85 c0                	test   %eax,%eax
80105ec0:	74 07                	je     80105ec9 <sys_open+0x174>
80105ec2:	b8 01 00 00 00       	mov    $0x1,%eax
80105ec7:	eb 05                	jmp    80105ece <sys_open+0x179>
80105ec9:	b8 00 00 00 00       	mov    $0x0,%eax
80105ece:	89 c2                	mov    %eax,%edx
80105ed0:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105ed3:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
80105ed6:	8b 45 ec             	mov    -0x14(%ebp),%eax
}
80105ed9:	c9                   	leave  
80105eda:	c3                   	ret    
...
80105ede:	83 ec 28             	sub    $0x28,%esp
  char *path;
  struct inode *ip;

  begin_trans();
80105ee1:	e8 2f d3 ff ff       	call   80103215 <begin_trans>
...
80105ef4:	e8 59 f5 ff ff       	call   80105452 <argstr>
80105ef9:	85 c0                	test   %eax,%eax
80105efb:	78 2c                	js     80105f29 <sys_mkdir+0x4e>
80105efd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f00:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105f07:	00 
80105f08:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105f0f:	00 
80105f10:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80105f17:	00 
80105f18:	89 04 24             	mov    %eax,(%esp)
80105f1b:	e8 75 fc ff ff       	call   80105b95 <create>
80105f20:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105f23:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105f27:	75 0c                	jne    80105f35 <sys_mkdir+0x5a>
    commit_trans();
80105f29:	e8 30 d3 ff ff       	call   8010325e <commit_trans>
    return -1;
80105f2e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f33:	eb 15                	jmp    80105f4a <sys_mkdir+0x6f>
  }
  iunlockput(ip);
80105f35:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f38:	89 04 24             	mov    %eax,(%esp)
80105f3b:	e8 a4 bb ff ff       	call   80101ae4 <iunlockput>
  commit_trans();
80105f40:	e8 19 d3 ff ff       	call   8010325e <commit_trans>
  return 0;
...
80105f4f:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
  ...
  begin_trans();
80105f52:	e8 be d2 ff ff       	call   80103215 <begin_trans>
  if((len=argstr(0, &path)) < 0 ||
80105f57:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105f5a:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f5e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105f65:	e8 e8 f4 ff ff       	call   80105452 <argstr>
80105f6a:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105f6d:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105f71:	78 5e                	js     80105fd1 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
80105f73:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105f76:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f7a:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105f81:	e8 3c f4 ff ff       	call   801053c2 <argint>
  char *path;
  int len;
  int major, minor;
...
80105f88:	78 47                	js     80105fd1 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80105f8a:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105f8d:	89 44 24 04          	mov    %eax,0x4(%esp)
80105f91:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80105f98:	e8 25 f4 ff ff       	call   801053c2 <argint>
  int len;
  int major, minor;
...
80105f9f:	78 30                	js     80105fd1 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
80105fa1:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105fa4:	0f bf c8             	movswl %ax,%ecx
80105fa7:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105faa:	0f bf d0             	movswl %ax,%edx
80105fad:	8b 45 ec             	mov    -0x14(%ebp),%eax
  int major, minor;
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80105fb0:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80105fb4:	89 54 24 08          	mov    %edx,0x8(%esp)
80105fb8:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80105fbf:	00 
80105fc0:	89 04 24             	mov    %eax,(%esp)
80105fc3:	e8 cd fb ff ff       	call   80105b95 <create>
80105fc8:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105fcb:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105fcf:	75 0c                	jne    80105fdd <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    commit_trans();
80105fd1:	e8 88 d2 ff ff       	call   8010325e <commit_trans>
    return -1;
80105fd6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105fdb:	eb 15                	jmp    80105ff2 <sys_mknod+0xa6>
  }
  iunlockput(ip);
80105fdd:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fe0:	89 04 24             	mov    %eax,(%esp)
80105fe3:	e8 fc ba ff ff       	call   80101ae4 <iunlockput>
  commit_trans();
80105fe8:	e8 71 d2 ff ff       	call   8010325e <commit_trans>
  return 0;
...
80106088:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
80106095:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010609c:	e8 b1 f3 ff ff       	call   80105452 <argstr>
801060a1:	85 c0                	test   %eax,%eax
801060a3:	78 1a                	js     801060bf <sys_exec+0x3a>
801060a5:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
801060ab:	89 44 24 04          	mov    %eax,0x4(%esp)
801060af:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801060b6:	e8 07 f3 ff ff       	call   801053c2 <argint>
801060bb:	85 c0                	test   %eax,%eax
801060bd:	79 0a                	jns    801060c9 <sys_exec+0x44>
    return -1;
801060bf:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060c4:	e9 cc 00 00 00       	jmp    80106195 <sys_exec+0x110>
  }
  memset(argv, 0, sizeof(argv));
801060c9:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
801060d0:	00 
801060d1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801060d8:	00 
801060d9:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801060df:	89 04 24             	mov    %eax,(%esp)
801060e2:	e8 7f ef ff ff       	call   80105066 <memset>
  for(i=0;; i++){
801060e7:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
801060ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
801060f1:	83 f8 1f             	cmp    $0x1f,%eax
801060f4:	76 0a                	jbe    80106100 <sys_exec+0x7b>
      return -1;
801060f6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060fb:	e9 95 00 00 00       	jmp    80106195 <sys_exec+0x110>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
80106100:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106103:	c1 e0 02             	shl    $0x2,%eax
80106106:	89 c2                	mov    %eax,%edx
80106108:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
8010610e:	01 c2                	add    %eax,%edx
80106110:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
80106116:	89 44 24 04          	mov    %eax,0x4(%esp)
8010611a:	89 14 24             	mov    %edx,(%esp)
8010611d:	e8 02 f2 ff ff       	call   80105324 <fetchint>
80106122:	85 c0                	test   %eax,%eax
80106124:	79 07                	jns    8010612d <sys_exec+0xa8>
      return -1;
80106126:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010612b:	eb 68                	jmp    80106195 <sys_exec+0x110>
    if(uarg == 0){
8010612d:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106133:	85 c0                	test   %eax,%eax
80106135:	75 26                	jne    8010615d <sys_exec+0xd8>
      argv[i] = 0;
80106137:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010613a:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
80106141:	00 00 00 00 
      break;
80106145:	90                   	nop
    }
...
80106149:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
8010614f:	89 54 24 04          	mov    %edx,0x4(%esp)
80106153:	89 04 24             	mov    %eax,(%esp)
80106156:	e8 a1 a9 ff ff       	call   80100afc <exec>
8010615b:	eb 38                	jmp    80106195 <sys_exec+0x110>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
80106160:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80106167:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
8010616d:	01 c2                	add    %eax,%edx
8010616f:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106175:	89 54 24 04          	mov    %edx,0x4(%esp)
80106179:	89 04 24             	mov    %eax,(%esp)
8010617c:	e8 dd f1 ff ff       	call   8010535e <fetchstr>
80106181:	85 c0                	test   %eax,%eax
80106183:	79 07                	jns    8010618c <sys_exec+0x107>
      return -1;
80106185:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010618a:	eb 09                	jmp    80106195 <sys_exec+0x110>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
8010618c:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
...
80106190:	e9 59 ff ff ff       	jmp    801060ee <sys_exec+0x69>
  return exec(path, argv);
}
80106195:	c9                   	leave  
80106196:	c3                   	ret    
...
80106267:	83 ec 08             	sub    $0x8,%esp
  return fork();
8010626a:	e8 64 e0 ff ff       	call   801042d3 <fork>
}
8010626f:	c9                   	leave  
80106270:	c3                   	ret    
...
80106274:	83 ec 08             	sub    $0x8,%esp
  exit();
80106277:	e8 ba e1 ff ff       	call   80104436 <exit>
...
80106286:	83 ec 08             	sub    $0x8,%esp
  return wait();
80106289:	e8 c0 e2 ff ff       	call   8010454e <wait>
}
8010628e:	c9                   	leave  
8010628f:	c3                   	ret    
...
801062a4:	e8 19 f1 ff ff       	call   801053c2 <argint>
801062a9:	85 c0                	test   %eax,%eax
801062ab:	79 07                	jns    801062b4 <sys_kill+0x24>
    return -1;
801062ad:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062b2:	eb 0b                	jmp    801062bf <sys_kill+0x2f>
  return kill(pid);
801062b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801062b7:	89 04 24             	mov    %eax,(%esp)
801062ba:	e8 4b e6 ff ff       	call   8010490a <kill>
}
801062bf:	c9                   	leave  
801062c0:	c3                   	ret    
...
801062ca:	8b 40 10             	mov    0x10(%eax),%eax
}
801062cd:	5d                   	pop    %ebp
801062ce:	c3                   	ret    
...
801062dc:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801062e3:	e8 da f0 ff ff       	call   801053c2 <argint>
801062e8:	85 c0                	test   %eax,%eax
801062ea:	79 07                	jns    801062f3 <sys_sbrk+0x24>
    return -1;
801062ec:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062f1:	eb 24                	jmp    80106317 <sys_sbrk+0x48>
  addr = proc->sz;
...
80106304:	e8 25 df ff ff       	call   8010422e <growproc>
80106309:	85 c0                	test   %eax,%eax
8010630b:	79 07                	jns    80106314 <sys_sbrk+0x45>
    return -1;
8010630d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106312:	eb 03                	jmp    80106317 <sys_sbrk+0x48>
  return addr;
...
8010632d:	e8 90 f0 ff ff       	call   801053c2 <argint>
80106332:	85 c0                	test   %eax,%eax
80106334:	79 07                	jns    8010633d <sys_sleep+0x24>
    return -1;
80106336:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010633b:	eb 6c                	jmp    801063a9 <sys_sleep+0x90>
  acquire(&tickslock);
8010633d:	c7 04 24 20 20 11 80 	movl   $0x80112020,(%esp)
80106344:	e8 ce ea ff ff       	call   80104e17 <acquire>
  ticks0 = ticks;
80106349:	a1 60 28 11 80       	mov    0x80112860,%eax
8010634e:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
80106351:	eb 34                	jmp    80106387 <sys_sleep+0x6e>
    if(proc->killed){
80106353:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106359:	8b 40 24             	mov    0x24(%eax),%eax
8010635c:	85 c0                	test   %eax,%eax
8010635e:	74 13                	je     80106373 <sys_sleep+0x5a>
      release(&tickslock);
80106360:	c7 04 24 20 20 11 80 	movl   $0x80112020,(%esp)
80106367:	e8 0d eb ff ff       	call   80104e79 <release>
      return -1;
8010636c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106371:	eb 36                	jmp    801063a9 <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
80106373:	c7 44 24 04 20 20 11 	movl   $0x80112020,0x4(%esp)
8010637a:	80 
8010637b:	c7 04 24 60 28 11 80 	movl   $0x80112860,(%esp)
80106382:	e8 7f e4 ff ff       	call   80104806 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80106387:	a1 60 28 11 80       	mov    0x80112860,%eax
8010638c:	89 c2                	mov    %eax,%edx
8010638e:	2b 55 f4             	sub    -0xc(%ebp),%edx
80106391:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106394:	39 c2                	cmp    %eax,%edx
80106396:	72 bb                	jb     80106353 <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
80106398:	c7 04 24 20 20 11 80 	movl   $0x80112020,(%esp)
8010639f:	e8 d5 ea ff ff       	call   80104e79 <release>
  return 0;
...
801063ae:	83 ec 28             	sub    $0x28,%esp
  uint xticks;
  
  acquire(&tickslock);
801063b1:	c7 04 24 20 20 11 80 	movl   $0x80112020,(%esp)
801063b8:	e8 5a ea ff ff       	call   80104e17 <acquire>
  xticks = ticks;
801063bd:	a1 60 28 11 80       	mov    0x80112860,%eax
801063c2:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
801063c5:	c7 04 24 20 20 11 80 	movl   $0x80112020,(%esp)
801063cc:	e8 a8 ea ff ff       	call   80104e79 <release>
  return xticks;
...
801063de:	8b 55 08             	mov    0x8(%ebp),%edx
801063e1:	8b 45 0c             	mov    0xc(%ebp),%eax
801063e4:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
801063e8:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
801063eb:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
801063ef:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
801063f3:	ee                   	out    %al,(%dx)
}
801063f4:	c9                   	leave  
801063f5:	c3                   	ret    
...
801063fc:	c7 44 24 04 34 00 00 	movl   $0x34,0x4(%esp)
80106403:	00 
80106404:	c7 04 24 43 00 00 00 	movl   $0x43,(%esp)
8010640b:	e8 c8 ff ff ff       	call   801063d8 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) % 256);
80106410:	c7 44 24 04 9c 00 00 	movl   $0x9c,0x4(%esp)
80106417:	00 
80106418:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
8010641f:	e8 b4 ff ff ff       	call   801063d8 <outb>
  outb(IO_TIMER1, TIMER_DIV(100) / 256);
80106424:	c7 44 24 04 2e 00 00 	movl   $0x2e,0x4(%esp)
8010642b:	00 
8010642c:	c7 04 24 40 00 00 00 	movl   $0x40,(%esp)
80106433:	e8 a0 ff ff ff       	call   801063d8 <outb>
  picenable(IRQ_TIMER);
80106438:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010643f:	e8 65 d6 ff ff       	call   80103aa9 <picenable>
}
80106444:	c9                   	leave  
80106445:	c3                   	ret    
	...
...
80106449:	06                   	push   %es
  pushl %fs
8010644a:	0f a0                	push   %fs
  pushl %gs
8010644c:	0f a8                	push   %gs
  pushal
8010644e:	60                   	pusha  
  
  # Set up data and per-cpu segments.
  movw $(SEG_KDATA<<3), %ax
8010644f:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80106453:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80106455:	8e c0                	mov    %eax,%es
  movw $(SEG_KCPU<<3), %ax
80106457:	66 b8 18 00          	mov    $0x18,%ax
  movw %ax, %fs
8010645b:	8e e0                	mov    %eax,%fs
  movw %ax, %gs
8010645d:	8e e8                	mov    %eax,%gs

  # Call trap(tf), where tf=%esp
  pushl %esp
8010645f:	54                   	push   %esp
  call trap
80106460:	e8 de 01 00 00       	call   80106643 <trap>
  addl $4, %esp
...
801064a4:	0f 20 d3             	mov    %cr2,%ebx
801064a7:	89 5d f8             	mov    %ebx,-0x8(%ebp)
  return val;
801064aa:	8b 45 f8             	mov    -0x8(%ebp),%eax
}
...
801064c0:	e9 c3 00 00 00       	jmp    80106588 <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
801064c5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064c8:	8b 04 85 48 b2 10 80 	mov    -0x7fef4db8(,%eax,4),%eax
801064cf:	89 c2                	mov    %eax,%edx
801064d1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064d4:	66 89 14 c5 60 20 11 	mov    %dx,-0x7feedfa0(,%eax,8)
801064db:	80 
801064dc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064df:	66 c7 04 c5 62 20 11 	movw   $0x8,-0x7feedf9e(,%eax,8)
801064e6:	80 08 00 
801064e9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801064ec:	0f b6 14 c5 64 20 11 	movzbl -0x7feedf9c(,%eax,8),%edx
801064f3:	80 
801064f4:	83 e2 e0             	and    $0xffffffe0,%edx
801064f7:	88 14 c5 64 20 11 80 	mov    %dl,-0x7feedf9c(,%eax,8)
801064fe:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106501:	0f b6 14 c5 64 20 11 	movzbl -0x7feedf9c(,%eax,8),%edx
80106508:	80 
80106509:	83 e2 1f             	and    $0x1f,%edx
8010650c:	88 14 c5 64 20 11 80 	mov    %dl,-0x7feedf9c(,%eax,8)
80106513:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106516:	0f b6 14 c5 65 20 11 	movzbl -0x7feedf9b(,%eax,8),%edx
8010651d:	80 
8010651e:	83 e2 f0             	and    $0xfffffff0,%edx
80106521:	83 ca 0e             	or     $0xe,%edx
80106524:	88 14 c5 65 20 11 80 	mov    %dl,-0x7feedf9b(,%eax,8)
8010652b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010652e:	0f b6 14 c5 65 20 11 	movzbl -0x7feedf9b(,%eax,8),%edx
80106535:	80 
80106536:	83 e2 ef             	and    $0xffffffef,%edx
80106539:	88 14 c5 65 20 11 80 	mov    %dl,-0x7feedf9b(,%eax,8)
80106540:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106543:	0f b6 14 c5 65 20 11 	movzbl -0x7feedf9b(,%eax,8),%edx
8010654a:	80 
8010654b:	83 e2 9f             	and    $0xffffff9f,%edx
8010654e:	88 14 c5 65 20 11 80 	mov    %dl,-0x7feedf9b(,%eax,8)
80106555:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106558:	0f b6 14 c5 65 20 11 	movzbl -0x7feedf9b(,%eax,8),%edx
8010655f:	80 
80106560:	83 ca 80             	or     $0xffffff80,%edx
80106563:	88 14 c5 65 20 11 80 	mov    %dl,-0x7feedf9b(,%eax,8)
8010656a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010656d:	8b 04 85 48 b2 10 80 	mov    -0x7fef4db8(,%eax,4),%eax
80106574:	c1 e8 10             	shr    $0x10,%eax
80106577:	89 c2                	mov    %eax,%edx
80106579:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010657c:	66 89 14 c5 66 20 11 	mov    %dx,-0x7feedf9a(,%eax,8)
80106583:	80 
void
tvinit(void)
{
...
8010658f:	0f 8e 30 ff ff ff    	jle    801064c5 <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80106595:	a1 48 b3 10 80       	mov    0x8010b348,%eax
8010659a:	66 a3 60 22 11 80    	mov    %ax,0x80112260
801065a0:	66 c7 05 62 22 11 80 	movw   $0x8,0x80112262
801065a7:	08 00 
801065a9:	0f b6 05 64 22 11 80 	movzbl 0x80112264,%eax
801065b0:	83 e0 e0             	and    $0xffffffe0,%eax
801065b3:	a2 64 22 11 80       	mov    %al,0x80112264
801065b8:	0f b6 05 64 22 11 80 	movzbl 0x80112264,%eax
801065bf:	83 e0 1f             	and    $0x1f,%eax
801065c2:	a2 64 22 11 80       	mov    %al,0x80112264
801065c7:	0f b6 05 65 22 11 80 	movzbl 0x80112265,%eax
801065ce:	83 c8 0f             	or     $0xf,%eax
801065d1:	a2 65 22 11 80       	mov    %al,0x80112265
801065d6:	0f b6 05 65 22 11 80 	movzbl 0x80112265,%eax
801065dd:	83 e0 ef             	and    $0xffffffef,%eax
801065e0:	a2 65 22 11 80       	mov    %al,0x80112265
801065e5:	0f b6 05 65 22 11 80 	movzbl 0x80112265,%eax
801065ec:	83 c8 60             	or     $0x60,%eax
801065ef:	a2 65 22 11 80       	mov    %al,0x80112265
801065f4:	0f b6 05 65 22 11 80 	movzbl 0x80112265,%eax
801065fb:	83 c8 80             	or     $0xffffff80,%eax
801065fe:	a2 65 22 11 80       	mov    %al,0x80112265
80106603:	a1 48 b3 10 80       	mov    0x8010b348,%eax
80106608:	c1 e8 10             	shr    $0x10,%eax
8010660b:	66 a3 66 22 11 80    	mov    %ax,0x80112266
  
  initlock(&tickslock, "time");
80106611:	c7 44 24 04 28 88 10 	movl   $0x80108828,0x4(%esp)
80106618:	80 
80106619:	c7 04 24 20 20 11 80 	movl   $0x80112020,(%esp)
80106620:	e8 d1 e7 ff ff       	call   80104df6 <initlock>
}
80106625:	c9                   	leave  
80106626:	c3                   	ret    
...
8010662a:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
8010662d:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
80106634:	00 
80106635:	c7 04 24 60 20 11 80 	movl   $0x80112060,(%esp)
8010663c:	e8 33 fe ff ff       	call   80106474 <lidt>
}
80106641:	c9                   	leave  
80106642:	c3                   	ret    
...
80106649:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
8010664c:	8b 45 08             	mov    0x8(%ebp),%eax
8010664f:	8b 40 30             	mov    0x30(%eax),%eax
80106652:	83 f8 40             	cmp    $0x40,%eax
80106655:	75 3e                	jne    80106695 <trap+0x52>
    if(proc->killed)
80106657:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010665d:	8b 40 24             	mov    0x24(%eax),%eax
80106660:	85 c0                	test   %eax,%eax
80106662:	74 05                	je     80106669 <trap+0x26>
      exit();
80106664:	e8 cd dd ff ff       	call   80104436 <exit>
    proc->tf = tf;
80106669:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010666f:	8b 55 08             	mov    0x8(%ebp),%edx
80106672:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
80106675:	e8 0f ee ff ff       	call   80105489 <syscall>
    if(proc->killed)
8010667a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106680:	8b 40 24             	mov    0x24(%eax),%eax
80106683:	85 c0                	test   %eax,%eax
80106685:	0f 84 34 02 00 00    	je     801068bf <trap+0x27c>
      exit();
8010668b:	e8 a6 dd ff ff       	call   80104436 <exit>
    return;
80106690:	e9 2a 02 00 00       	jmp    801068bf <trap+0x27c>
  }

  switch(tf->trapno){
80106695:	8b 45 08             	mov    0x8(%ebp),%eax
80106698:	8b 40 30             	mov    0x30(%eax),%eax
8010669b:	83 e8 20             	sub    $0x20,%eax
8010669e:	83 f8 1f             	cmp    $0x1f,%eax
801066a1:	0f 87 bc 00 00 00    	ja     80106763 <trap+0x120>
801066a7:	8b 04 85 d0 88 10 80 	mov    -0x7fef7730(,%eax,4),%eax
801066ae:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
801066b0:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801066b6:	0f b6 00             	movzbl (%eax),%eax
801066b9:	84 c0                	test   %al,%al
801066bb:	75 31                	jne    801066ee <trap+0xab>
      acquire(&tickslock);
801066bd:	c7 04 24 20 20 11 80 	movl   $0x80112020,(%esp)
801066c4:	e8 4e e7 ff ff       	call   80104e17 <acquire>
      ticks++;
801066c9:	a1 60 28 11 80       	mov    0x80112860,%eax
801066ce:	83 c0 01             	add    $0x1,%eax
801066d1:	a3 60 28 11 80       	mov    %eax,0x80112860
      wakeup(&ticks);
801066d6:	c7 04 24 60 28 11 80 	movl   $0x80112860,(%esp)
801066dd:	e8 fd e1 ff ff       	call   801048df <wakeup>
      release(&tickslock);
801066e2:	c7 04 24 20 20 11 80 	movl   $0x80112020,(%esp)
801066e9:	e8 8b e7 ff ff       	call   80104e79 <release>
    }
    lapiceoi();
801066ee:	e8 ee c7 ff ff       	call   80102ee1 <lapiceoi>
    break;
801066f3:	e9 41 01 00 00       	jmp    80106839 <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801066f8:	e8 ec bf ff ff       	call   801026e9 <ideintr>
    lapiceoi();
801066fd:	e8 df c7 ff ff       	call   80102ee1 <lapiceoi>
    break;
80106702:	e9 32 01 00 00       	jmp    80106839 <trap+0x1f6>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
80106707:	e8 b3 c5 ff ff       	call   80102cbf <kbdintr>
    lapiceoi();
8010670c:	e8 d0 c7 ff ff       	call   80102ee1 <lapiceoi>
    break;
80106711:	e9 23 01 00 00       	jmp    80106839 <trap+0x1f6>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
80106716:	e8 a9 03 00 00       	call   80106ac4 <uartintr>
    lapiceoi();
8010671b:	e8 c1 c7 ff ff       	call   80102ee1 <lapiceoi>
    break;
80106720:	e9 14 01 00 00       	jmp    80106839 <trap+0x1f6>
  case T_IRQ0 + 7:
...
80106725:	8b 45 08             	mov    0x8(%ebp),%eax
  ...
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106728:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
8010672b:	8b 45 08             	mov    0x8(%ebp),%eax
8010672e:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80106732:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
80106735:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010673b:	0f b6 00             	movzbl (%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
8010673e:	0f b6 c0             	movzbl %al,%eax
80106741:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106745:	89 54 24 08          	mov    %edx,0x8(%esp)
80106749:	89 44 24 04          	mov    %eax,0x4(%esp)
8010674d:	c7 04 24 30 88 10 80 	movl   $0x80108830,(%esp)
80106754:	e8 48 9c ff ff       	call   801003a1 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80106759:	e8 83 c7 ff ff       	call   80102ee1 <lapiceoi>
    break;
8010675e:	e9 d6 00 00 00       	jmp    80106839 <trap+0x1f6>
   
  //PAGEBREAK: 13
  default:
    if(proc == 0 || (tf->cs&3) == 0){
80106763:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106769:	85 c0                	test   %eax,%eax
8010676b:	74 11                	je     8010677e <trap+0x13b>
8010676d:	8b 45 08             	mov    0x8(%ebp),%eax
80106770:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106774:	0f b7 c0             	movzwl %ax,%eax
80106777:	83 e0 03             	and    $0x3,%eax
8010677a:	85 c0                	test   %eax,%eax
8010677c:	75 46                	jne    801067c4 <trap+0x181>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010677e:	e8 1a fd ff ff       	call   8010649d <rcr2>
...
80106783:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106786:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106789:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80106790:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106793:	0f b6 ca             	movzbl %dl,%ecx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106796:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106799:	8b 52 30             	mov    0x30(%edx),%edx
8010679c:	89 44 24 10          	mov    %eax,0x10(%esp)
801067a0:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
801067a4:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801067a8:	89 54 24 04          	mov    %edx,0x4(%esp)
801067ac:	c7 04 24 54 88 10 80 	movl   $0x80108854,(%esp)
801067b3:	e8 e9 9b ff ff       	call   801003a1 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
801067b8:	c7 04 24 86 88 10 80 	movl   $0x80108886,(%esp)
801067bf:	e8 79 9d ff ff       	call   8010053d <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801067c4:	e8 d4 fc ff ff       	call   8010649d <rcr2>
801067c9:	89 c2                	mov    %eax,%edx
...
801067cb:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801067ce:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
...
801067d7:	0f b6 00             	movzbl (%eax),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801067da:	0f b6 f0             	movzbl %al,%esi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801067dd:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801067e0:	8b 58 34             	mov    0x34(%eax),%ebx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801067e3:	8b 45 08             	mov    0x8(%ebp),%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801067e6:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801067e9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801067ef:	83 c0 6c             	add    $0x6c,%eax
801067f2:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801067f5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801067fb:	8b 40 10             	mov    0x10(%eax),%eax
801067fe:	89 54 24 1c          	mov    %edx,0x1c(%esp)
80106802:	89 7c 24 18          	mov    %edi,0x18(%esp)
80106806:	89 74 24 14          	mov    %esi,0x14(%esp)
8010680a:	89 5c 24 10          	mov    %ebx,0x10(%esp)
8010680e:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106812:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106815:	89 54 24 08          	mov    %edx,0x8(%esp)
80106819:	89 44 24 04          	mov    %eax,0x4(%esp)
8010681d:	c7 04 24 8c 88 10 80 	movl   $0x8010888c,(%esp)
80106824:	e8 78 9b ff ff       	call   801003a1 <cprintf>
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
            rcr2());
    proc->killed = 1;
80106829:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010682f:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80106836:	eb 01                	jmp    80106839 <trap+0x1f6>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
80106841:	74 24                	je     80106867 <trap+0x224>
80106843:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106849:	8b 40 24             	mov    0x24(%eax),%eax
8010684c:	85 c0                	test   %eax,%eax
8010684e:	74 17                	je     80106867 <trap+0x224>
...
8010685d:	83 f8 03             	cmp    $0x3,%eax
80106860:	75 05                	jne    80106867 <trap+0x224>
    exit();
80106862:	e8 cf db ff ff       	call   80104436 <exit>
...
8010686f:	74 1e                	je     8010688f <trap+0x24c>
80106871:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106877:	8b 40 0c             	mov    0xc(%eax),%eax
8010687a:	83 f8 04             	cmp    $0x4,%eax
8010687d:	75 10                	jne    8010688f <trap+0x24c>
8010687f:	8b 45 08             	mov    0x8(%ebp),%eax
80106882:	8b 40 30             	mov    0x30(%eax),%eax
80106885:	83 f8 20             	cmp    $0x20,%eax
80106888:	75 05                	jne    8010688f <trap+0x24c>
    yield();
8010688a:	e8 19 df ff ff       	call   801047a8 <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
8010688f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106895:	85 c0                	test   %eax,%eax
80106897:	74 27                	je     801068c0 <trap+0x27d>
80106899:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010689f:	8b 40 24             	mov    0x24(%eax),%eax
801068a2:	85 c0                	test   %eax,%eax
801068a4:	74 1a                	je     801068c0 <trap+0x27d>
801068a6:	8b 45 08             	mov    0x8(%ebp),%eax
801068a9:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
801068ad:	0f b7 c0             	movzwl %ax,%eax
801068b0:	83 e0 03             	and    $0x3,%eax
801068b3:	83 f8 03             	cmp    $0x3,%eax
801068b6:	75 08                	jne    801068c0 <trap+0x27d>
    exit();
801068b8:	e8 79 db ff ff       	call   80104436 <exit>
801068bd:	eb 01                	jmp    801068c0 <trap+0x27d>
      exit();
    proc->tf = tf;
    syscall();
    if(proc->killed)
...
801068c0:	83 c4 3c             	add    $0x3c,%esp
801068c3:	5b                   	pop    %ebx
801068c4:	5e                   	pop    %esi
801068c5:	5f                   	pop    %edi
801068c6:	5d                   	pop    %ebp
...
801068cc:	83 ec 14             	sub    $0x14,%esp
801068cf:	8b 45 08             	mov    0x8(%ebp),%eax
801068d2:	66 89 45 e8          	mov    %ax,-0x18(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
801068d6:	0f b7 55 e8          	movzwl -0x18(%ebp),%edx
801068da:	66 89 55 ea          	mov    %dx,-0x16(%ebp)
801068de:	0f b7 55 ea          	movzwl -0x16(%ebp),%edx
801068e2:	ec                   	in     (%dx),%al
801068e3:	89 c3                	mov    %eax,%ebx
801068e5:	88 5d fb             	mov    %bl,-0x5(%ebp)
  return data;
801068e8:	0f b6 45 fb          	movzbl -0x5(%ebp),%eax
}
801068ec:	83 c4 14             	add    $0x14,%esp
801068ef:	5b                   	pop    %ebx
801068f0:	5d                   	pop    %ebp
801068f1:	c3                   	ret    
...
80106913:	83 ec 28             	sub    $0x28,%esp
  ...
  // Turn off the FIFO
  outb(COM1+2, 0);
80106916:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
8010691d:	00 
8010691e:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106925:	e8 c8 ff ff ff       	call   801068f2 <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
8010692a:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106931:	00 
80106932:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106939:	e8 b4 ff ff ff       	call   801068f2 <outb>
  outb(COM1+0, 115200/9600);
8010693e:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106945:	00 
80106946:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
8010694d:	e8 a0 ff ff ff       	call   801068f2 <outb>
  outb(COM1+1, 0);
80106952:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106959:	00 
8010695a:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106961:	e8 8c ff ff ff       	call   801068f2 <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106966:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
8010696d:	00 
8010696e:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106975:	e8 78 ff ff ff       	call   801068f2 <outb>
  outb(COM1+4, 0);
8010697a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106981:	00 
80106982:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106989:	e8 64 ff ff ff       	call   801068f2 <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
8010698e:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106995:	00 
80106996:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
8010699d:	e8 50 ff ff ff       	call   801068f2 <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
801069a2:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
801069a9:	e8 1a ff ff ff       	call   801068c8 <inb>
801069ae:	3c ff                	cmp    $0xff,%al
801069b0:	74 6c                	je     80106a1e <uartinit+0x10e>
    return;
  uart = 1;
801069b2:	c7 05 14 b8 10 80 01 	movl   $0x1,0x8010b814
801069b9:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
801069bc:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
801069c3:	e8 00 ff ff ff       	call   801068c8 <inb>
  inb(COM1+0);
801069c8:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
801069cf:	e8 f4 fe ff ff       	call   801068c8 <inb>
  picenable(IRQ_COM1);
801069d4:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
801069db:	e8 c9 d0 ff ff       	call   80103aa9 <picenable>
  ioapicenable(IRQ_COM1, 0);
801069e0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801069e7:	00 
801069e8:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
801069ef:	e8 7a bf ff ff       	call   8010296e <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
801069f4:	c7 45 f4 50 89 10 80 	movl   $0x80108950,-0xc(%ebp)
801069fb:	eb 15                	jmp    80106a12 <uartinit+0x102>
    uartputc(*p);
801069fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106a00:	0f b6 00             	movzbl (%eax),%eax
80106a03:	0f be c0             	movsbl %al,%eax
80106a06:	89 04 24             	mov    %eax,(%esp)
80106a09:	e8 13 00 00 00       	call   80106a21 <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
...
80106a18:	84 c0                	test   %al,%al
80106a1a:	75 e1                	jne    801069fd <uartinit+0xed>
80106a1c:	eb 01                	jmp    80106a1f <uartinit+0x10f>
  outb(COM1+4, 0);
  outb(COM1+1, 0x01);    // Enable receive interrupts.
...
80106a24:	83 ec 28             	sub    $0x28,%esp
  int i;

  if(!uart)
80106a27:	a1 14 b8 10 80       	mov    0x8010b814,%eax
80106a2c:	85 c0                	test   %eax,%eax
80106a2e:	74 4d                	je     80106a7d <uartputc+0x5c>
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106a30:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106a37:	eb 10                	jmp    80106a49 <uartputc+0x28>
    microdelay(10);
80106a39:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106a40:	e8 c1 c4 ff ff       	call   80102f06 <microdelay>
{
  int i;
...
80106a76:	e8 77 fe ff ff       	call   801068f2 <outb>
80106a7b:	eb 01                	jmp    80106a7e <uartputc+0x5d>
uartputc(int c)
{
  int i;
...
80106a83:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106a86:	a1 14 b8 10 80       	mov    0x8010b814,%eax
80106a8b:	85 c0                	test   %eax,%eax
80106a8d:	75 07                	jne    80106a96 <uartgetc+0x16>
    return -1;
80106a8f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106a94:	eb 2c                	jmp    80106ac2 <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106a96:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106a9d:	e8 26 fe ff ff       	call   801068c8 <inb>
80106aa2:	0f b6 c0             	movzbl %al,%eax
80106aa5:	83 e0 01             	and    $0x1,%eax
80106aa8:	85 c0                	test   %eax,%eax
80106aaa:	75 07                	jne    80106ab3 <uartgetc+0x33>
    return -1;
80106aac:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106ab1:	eb 0f                	jmp    80106ac2 <uartgetc+0x42>
  return inb(COM1+0);
80106ab3:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106aba:	e8 09 fe ff ff       	call   801068c8 <inb>
...
80106aca:	c7 04 24 80 6a 10 80 	movl   $0x80106a80,(%esp)
80106ad1:	e8 d7 9c ff ff       	call   801007ad <consoleintr>
}
80106ad6:	c9                   	leave  
80106ad7:	c3                   	ret    
...
80106ada:	6a 00                	push   $0x0
  jmp alltraps
80106adc:	e9 67 f9 ff ff       	jmp    80106448 <alltraps>
...
80106ae3:	6a 01                	push   $0x1
  jmp alltraps
80106ae5:	e9 5e f9 ff ff       	jmp    80106448 <alltraps>
...
80106aec:	6a 02                	push   $0x2
  jmp alltraps
80106aee:	e9 55 f9 ff ff       	jmp    80106448 <alltraps>
...
80106af5:	6a 03                	push   $0x3
  jmp alltraps
80106af7:	e9 4c f9 ff ff       	jmp    80106448 <alltraps>
...
80106afe:	6a 04                	push   $0x4
  jmp alltraps
80106b00:	e9 43 f9 ff ff       	jmp    80106448 <alltraps>
...
80106b07:	6a 05                	push   $0x5
  jmp alltraps
80106b09:	e9 3a f9 ff ff       	jmp    80106448 <alltraps>
...
80106b10:	6a 06                	push   $0x6
  jmp alltraps
80106b12:	e9 31 f9 ff ff       	jmp    80106448 <alltraps>
...
80106b19:	6a 07                	push   $0x7
  jmp alltraps
80106b1b:	e9 28 f9 ff ff       	jmp    80106448 <alltraps>
...
80106b20:	6a 08                	push   $0x8
  jmp alltraps
80106b22:	e9 21 f9 ff ff       	jmp    80106448 <alltraps>
...
80106b29:	6a 09                	push   $0x9
  jmp alltraps
80106b2b:	e9 18 f9 ff ff       	jmp    80106448 <alltraps>
...
80106b30:	6a 0a                	push   $0xa
  jmp alltraps
80106b32:	e9 11 f9 ff ff       	jmp    80106448 <alltraps>
...
80106b37:	6a 0b                	push   $0xb
  jmp alltraps
80106b39:	e9 0a f9 ff ff       	jmp    80106448 <alltraps>
...
80106b3e:	6a 0c                	push   $0xc
  jmp alltraps
80106b40:	e9 03 f9 ff ff       	jmp    80106448 <alltraps>
...
80106b45:	6a 0d                	push   $0xd
  jmp alltraps
80106b47:	e9 fc f8 ff ff       	jmp    80106448 <alltraps>
...
80106b4c:	6a 0e                	push   $0xe
  jmp alltraps
80106b4e:	e9 f5 f8 ff ff       	jmp    80106448 <alltraps>
...
80106b55:	6a 0f                	push   $0xf
  jmp alltraps
80106b57:	e9 ec f8 ff ff       	jmp    80106448 <alltraps>
...
80106b5e:	6a 10                	push   $0x10
  jmp alltraps
80106b60:	e9 e3 f8 ff ff       	jmp    80106448 <alltraps>
...
80106b65:	6a 11                	push   $0x11
  jmp alltraps
80106b67:	e9 dc f8 ff ff       	jmp    80106448 <alltraps>
...
80106b6e:	6a 12                	push   $0x12
  jmp alltraps
80106b70:	e9 d3 f8 ff ff       	jmp    80106448 <alltraps>
...
80106b77:	6a 13                	push   $0x13
  jmp alltraps
80106b79:	e9 ca f8 ff ff       	jmp    80106448 <alltraps>
...
80106b80:	6a 14                	push   $0x14
  jmp alltraps
80106b82:	e9 c1 f8 ff ff       	jmp    80106448 <alltraps>
...
80106b89:	6a 15                	push   $0x15
  jmp alltraps
80106b8b:	e9 b8 f8 ff ff       	jmp    80106448 <alltraps>
...
80106b92:	6a 16                	push   $0x16
  jmp alltraps
80106b94:	e9 af f8 ff ff       	jmp    80106448 <alltraps>
...
80106b9b:	6a 17                	push   $0x17
  jmp alltraps
80106b9d:	e9 a6 f8 ff ff       	jmp    80106448 <alltraps>
...
80106ba4:	6a 18                	push   $0x18
  jmp alltraps
80106ba6:	e9 9d f8 ff ff       	jmp    80106448 <alltraps>
...
80106bad:	6a 19                	push   $0x19
  jmp alltraps
80106baf:	e9 94 f8 ff ff       	jmp    80106448 <alltraps>
...
80106bb6:	6a 1a                	push   $0x1a
  jmp alltraps
80106bb8:	e9 8b f8 ff ff       	jmp    80106448 <alltraps>
...
80106bbf:	6a 1b                	push   $0x1b
  jmp alltraps
80106bc1:	e9 82 f8 ff ff       	jmp    80106448 <alltraps>
...
80106bc8:	6a 1c                	push   $0x1c
  jmp alltraps
80106bca:	e9 79 f8 ff ff       	jmp    80106448 <alltraps>
...
80106bd1:	6a 1d                	push   $0x1d
  jmp alltraps
80106bd3:	e9 70 f8 ff ff       	jmp    80106448 <alltraps>
...
80106bda:	6a 1e                	push   $0x1e
  jmp alltraps
80106bdc:	e9 67 f8 ff ff       	jmp    80106448 <alltraps>
...
80106be3:	6a 1f                	push   $0x1f
  jmp alltraps
80106be5:	e9 5e f8 ff ff       	jmp    80106448 <alltraps>
...
80106bec:	6a 20                	push   $0x20
  jmp alltraps
80106bee:	e9 55 f8 ff ff       	jmp    80106448 <alltraps>
...
80106bf5:	6a 21                	push   $0x21
  jmp alltraps
80106bf7:	e9 4c f8 ff ff       	jmp    80106448 <alltraps>
...
80106bfe:	6a 22                	push   $0x22
  jmp alltraps
80106c00:	e9 43 f8 ff ff       	jmp    80106448 <alltraps>
...
80106c07:	6a 23                	push   $0x23
  jmp alltraps
80106c09:	e9 3a f8 ff ff       	jmp    80106448 <alltraps>
...
80106c10:	6a 24                	push   $0x24
  jmp alltraps
80106c12:	e9 31 f8 ff ff       	jmp    80106448 <alltraps>
...
80106c19:	6a 25                	push   $0x25
  jmp alltraps
80106c1b:	e9 28 f8 ff ff       	jmp    80106448 <alltraps>
...
80106c22:	6a 26                	push   $0x26
  jmp alltraps
80106c24:	e9 1f f8 ff ff       	jmp    80106448 <alltraps>
...
80106c2b:	6a 27                	push   $0x27
  jmp alltraps
80106c2d:	e9 16 f8 ff ff       	jmp    80106448 <alltraps>
...
80106c34:	6a 28                	push   $0x28
  jmp alltraps
80106c36:	e9 0d f8 ff ff       	jmp    80106448 <alltraps>
...
80106c3d:	6a 29                	push   $0x29
  jmp alltraps
80106c3f:	e9 04 f8 ff ff       	jmp    80106448 <alltraps>
...
80106c46:	6a 2a                	push   $0x2a
  jmp alltraps
80106c48:	e9 fb f7 ff ff       	jmp    80106448 <alltraps>
...
80106c4f:	6a 2b                	push   $0x2b
  jmp alltraps
80106c51:	e9 f2 f7 ff ff       	jmp    80106448 <alltraps>
...
80106c58:	6a 2c                	push   $0x2c
  jmp alltraps
80106c5a:	e9 e9 f7 ff ff       	jmp    80106448 <alltraps>
...
80106c61:	6a 2d                	push   $0x2d
  jmp alltraps
80106c63:	e9 e0 f7 ff ff       	jmp    80106448 <alltraps>
...
80106c6a:	6a 2e                	push   $0x2e
  jmp alltraps
80106c6c:	e9 d7 f7 ff ff       	jmp    80106448 <alltraps>
...
80106c73:	6a 2f                	push   $0x2f
  jmp alltraps
80106c75:	e9 ce f7 ff ff       	jmp    80106448 <alltraps>
...
80106c7c:	6a 30                	push   $0x30
  jmp alltraps
80106c7e:	e9 c5 f7 ff ff       	jmp    80106448 <alltraps>
...
80106c85:	6a 31                	push   $0x31
  jmp alltraps
80106c87:	e9 bc f7 ff ff       	jmp    80106448 <alltraps>
...
80106c8e:	6a 32                	push   $0x32
  jmp alltraps
80106c90:	e9 b3 f7 ff ff       	jmp    80106448 <alltraps>
...
80106c97:	6a 33                	push   $0x33
  jmp alltraps
80106c99:	e9 aa f7 ff ff       	jmp    80106448 <alltraps>
...
80106ca0:	6a 34                	push   $0x34
  jmp alltraps
80106ca2:	e9 a1 f7 ff ff       	jmp    80106448 <alltraps>
...
80106ca9:	6a 35                	push   $0x35
  jmp alltraps
80106cab:	e9 98 f7 ff ff       	jmp    80106448 <alltraps>
...
80106cb2:	6a 36                	push   $0x36
  jmp alltraps
80106cb4:	e9 8f f7 ff ff       	jmp    80106448 <alltraps>
...
80106cbb:	6a 37                	push   $0x37
  jmp alltraps
80106cbd:	e9 86 f7 ff ff       	jmp    80106448 <alltraps>
...
80106cc4:	6a 38                	push   $0x38
  jmp alltraps
80106cc6:	e9 7d f7 ff ff       	jmp    80106448 <alltraps>
...
80106ccd:	6a 39                	push   $0x39
  jmp alltraps
80106ccf:	e9 74 f7 ff ff       	jmp    80106448 <alltraps>
...
80106cd6:	6a 3a                	push   $0x3a
  jmp alltraps
80106cd8:	e9 6b f7 ff ff       	jmp    80106448 <alltraps>
...
80106cdf:	6a 3b                	push   $0x3b
  jmp alltraps
80106ce1:	e9 62 f7 ff ff       	jmp    80106448 <alltraps>
...
80106ce8:	6a 3c                	push   $0x3c
  jmp alltraps
80106cea:	e9 59 f7 ff ff       	jmp    80106448 <alltraps>
...
80106cf1:	6a 3d                	push   $0x3d
  jmp alltraps
80106cf3:	e9 50 f7 ff ff       	jmp    80106448 <alltraps>
...
80106cfa:	6a 3e                	push   $0x3e
  jmp alltraps
80106cfc:	e9 47 f7 ff ff       	jmp    80106448 <alltraps>
...
80106d03:	6a 3f                	push   $0x3f
  jmp alltraps
80106d05:	e9 3e f7 ff ff       	jmp    80106448 <alltraps>
...
80106d0c:	6a 40                	push   $0x40
  jmp alltraps
80106d0e:	e9 35 f7 ff ff       	jmp    80106448 <alltraps>
...
80106d15:	6a 41                	push   $0x41
  jmp alltraps
80106d17:	e9 2c f7 ff ff       	jmp    80106448 <alltraps>
...
80106d1e:	6a 42                	push   $0x42
  jmp alltraps
80106d20:	e9 23 f7 ff ff       	jmp    80106448 <alltraps>
...
80106d27:	6a 43                	push   $0x43
  jmp alltraps
80106d29:	e9 1a f7 ff ff       	jmp    80106448 <alltraps>
...
80106d30:	6a 44                	push   $0x44
  jmp alltraps
80106d32:	e9 11 f7 ff ff       	jmp    80106448 <alltraps>
...
80106d39:	6a 45                	push   $0x45
  jmp alltraps
80106d3b:	e9 08 f7 ff ff       	jmp    80106448 <alltraps>
...
80106d42:	6a 46                	push   $0x46
  jmp alltraps
80106d44:	e9 ff f6 ff ff       	jmp    80106448 <alltraps>
...
80106d4b:	6a 47                	push   $0x47
  jmp alltraps
80106d4d:	e9 f6 f6 ff ff       	jmp    80106448 <alltraps>
...
80106d54:	6a 48                	push   $0x48
  jmp alltraps
80106d56:	e9 ed f6 ff ff       	jmp    80106448 <alltraps>
...
80106d5d:	6a 49                	push   $0x49
  jmp alltraps
80106d5f:	e9 e4 f6 ff ff       	jmp    80106448 <alltraps>
...
80106d66:	6a 4a                	push   $0x4a
  jmp alltraps
80106d68:	e9 db f6 ff ff       	jmp    80106448 <alltraps>
...
80106d6f:	6a 4b                	push   $0x4b
  jmp alltraps
80106d71:	e9 d2 f6 ff ff       	jmp    80106448 <alltraps>
...
80106d78:	6a 4c                	push   $0x4c
  jmp alltraps
80106d7a:	e9 c9 f6 ff ff       	jmp    80106448 <alltraps>
...
80106d81:	6a 4d                	push   $0x4d
  jmp alltraps
80106d83:	e9 c0 f6 ff ff       	jmp    80106448 <alltraps>
...
80106d8a:	6a 4e                	push   $0x4e
  jmp alltraps
80106d8c:	e9 b7 f6 ff ff       	jmp    80106448 <alltraps>
...
80106d93:	6a 4f                	push   $0x4f
  jmp alltraps
80106d95:	e9 ae f6 ff ff       	jmp    80106448 <alltraps>
...
80106d9c:	6a 50                	push   $0x50
  jmp alltraps
80106d9e:	e9 a5 f6 ff ff       	jmp    80106448 <alltraps>
...
80106da5:	6a 51                	push   $0x51
  jmp alltraps
80106da7:	e9 9c f6 ff ff       	jmp    80106448 <alltraps>
...
80106dae:	6a 52                	push   $0x52
  jmp alltraps
80106db0:	e9 93 f6 ff ff       	jmp    80106448 <alltraps>
...
80106db7:	6a 53                	push   $0x53
  jmp alltraps
80106db9:	e9 8a f6 ff ff       	jmp    80106448 <alltraps>
...
80106dc0:	6a 54                	push   $0x54
  jmp alltraps
80106dc2:	e9 81 f6 ff ff       	jmp    80106448 <alltraps>
...
80106dc9:	6a 55                	push   $0x55
  jmp alltraps
80106dcb:	e9 78 f6 ff ff       	jmp    80106448 <alltraps>
...
80106dd2:	6a 56                	push   $0x56
  jmp alltraps
80106dd4:	e9 6f f6 ff ff       	jmp    80106448 <alltraps>
...
80106ddb:	6a 57                	push   $0x57
  jmp alltraps
80106ddd:	e9 66 f6 ff ff       	jmp    80106448 <alltraps>
...
80106de4:	6a 58                	push   $0x58
  jmp alltraps
80106de6:	e9 5d f6 ff ff       	jmp    80106448 <alltraps>
...
80106ded:	6a 59                	push   $0x59
  jmp alltraps
80106def:	e9 54 f6 ff ff       	jmp    80106448 <alltraps>
...
80106df6:	6a 5a                	push   $0x5a
  jmp alltraps
80106df8:	e9 4b f6 ff ff       	jmp    80106448 <alltraps>
...
80106dff:	6a 5b                	push   $0x5b
  jmp alltraps
80106e01:	e9 42 f6 ff ff       	jmp    80106448 <alltraps>
...
80106e08:	6a 5c                	push   $0x5c
  jmp alltraps
80106e0a:	e9 39 f6 ff ff       	jmp    80106448 <alltraps>
...
80106e11:	6a 5d                	push   $0x5d
  jmp alltraps
80106e13:	e9 30 f6 ff ff       	jmp    80106448 <alltraps>
...
80106e1a:	6a 5e                	push   $0x5e
  jmp alltraps
80106e1c:	e9 27 f6 ff ff       	jmp    80106448 <alltraps>
...
80106e23:	6a 5f                	push   $0x5f
  jmp alltraps
80106e25:	e9 1e f6 ff ff       	jmp    80106448 <alltraps>
...
80106e2c:	6a 60                	push   $0x60
  jmp alltraps
80106e2e:	e9 15 f6 ff ff       	jmp    80106448 <alltraps>
...
80106e35:	6a 61                	push   $0x61
  jmp alltraps
80106e37:	e9 0c f6 ff ff       	jmp    80106448 <alltraps>
...
80106e3e:	6a 62                	push   $0x62
  jmp alltraps
80106e40:	e9 03 f6 ff ff       	jmp    80106448 <alltraps>
...
80106e47:	6a 63                	push   $0x63
  jmp alltraps
80106e49:	e9 fa f5 ff ff       	jmp    80106448 <alltraps>
...
80106e50:	6a 64                	push   $0x64
  jmp alltraps
80106e52:	e9 f1 f5 ff ff       	jmp    80106448 <alltraps>
...
80106e59:	6a 65                	push   $0x65
  jmp alltraps
80106e5b:	e9 e8 f5 ff ff       	jmp    80106448 <alltraps>
...
80106e62:	6a 66                	push   $0x66
  jmp alltraps
80106e64:	e9 df f5 ff ff       	jmp    80106448 <alltraps>
...
80106e6b:	6a 67                	push   $0x67
  jmp alltraps
80106e6d:	e9 d6 f5 ff ff       	jmp    80106448 <alltraps>
...
80106e74:	6a 68                	push   $0x68
  jmp alltraps
80106e76:	e9 cd f5 ff ff       	jmp    80106448 <alltraps>
...
80106e7d:	6a 69                	push   $0x69
  jmp alltraps
80106e7f:	e9 c4 f5 ff ff       	jmp    80106448 <alltraps>
...
80106e86:	6a 6a                	push   $0x6a
  jmp alltraps
80106e88:	e9 bb f5 ff ff       	jmp    80106448 <alltraps>
...
80106e8f:	6a 6b                	push   $0x6b
  jmp alltraps
80106e91:	e9 b2 f5 ff ff       	jmp    80106448 <alltraps>
...
80106e98:	6a 6c                	push   $0x6c
  jmp alltraps
80106e9a:	e9 a9 f5 ff ff       	jmp    80106448 <alltraps>
...
80106ea1:	6a 6d                	push   $0x6d
  jmp alltraps
80106ea3:	e9 a0 f5 ff ff       	jmp    80106448 <alltraps>
...
80106eaa:	6a 6e                	push   $0x6e
  jmp alltraps
80106eac:	e9 97 f5 ff ff       	jmp    80106448 <alltraps>
...
80106eb3:	6a 6f                	push   $0x6f
  jmp alltraps
80106eb5:	e9 8e f5 ff ff       	jmp    80106448 <alltraps>
...
80106ebc:	6a 70                	push   $0x70
  jmp alltraps
80106ebe:	e9 85 f5 ff ff       	jmp    80106448 <alltraps>
...
80106ec5:	6a 71                	push   $0x71
  jmp alltraps
80106ec7:	e9 7c f5 ff ff       	jmp    80106448 <alltraps>
...
80106ece:	6a 72                	push   $0x72
  jmp alltraps
80106ed0:	e9 73 f5 ff ff       	jmp    80106448 <alltraps>
...
80106ed7:	6a 73                	push   $0x73
  jmp alltraps
80106ed9:	e9 6a f5 ff ff       	jmp    80106448 <alltraps>
...
80106ee0:	6a 74                	push   $0x74
  jmp alltraps
80106ee2:	e9 61 f5 ff ff       	jmp    80106448 <alltraps>
...
80106ee9:	6a 75                	push   $0x75
  jmp alltraps
80106eeb:	e9 58 f5 ff ff       	jmp    80106448 <alltraps>
...
80106ef2:	6a 76                	push   $0x76
  jmp alltraps
80106ef4:	e9 4f f5 ff ff       	jmp    80106448 <alltraps>
...
80106efb:	6a 77                	push   $0x77
  jmp alltraps
80106efd:	e9 46 f5 ff ff       	jmp    80106448 <alltraps>
...
80106f04:	6a 78                	push   $0x78
  jmp alltraps
80106f06:	e9 3d f5 ff ff       	jmp    80106448 <alltraps>
...
80106f0d:	6a 79                	push   $0x79
  jmp alltraps
80106f0f:	e9 34 f5 ff ff       	jmp    80106448 <alltraps>
...
80106f16:	6a 7a                	push   $0x7a
  jmp alltraps
80106f18:	e9 2b f5 ff ff       	jmp    80106448 <alltraps>
...
80106f1f:	6a 7b                	push   $0x7b
  jmp alltraps
80106f21:	e9 22 f5 ff ff       	jmp    80106448 <alltraps>
...
80106f28:	6a 7c                	push   $0x7c
  jmp alltraps
80106f2a:	e9 19 f5 ff ff       	jmp    80106448 <alltraps>
...
80106f31:	6a 7d                	push   $0x7d
  jmp alltraps
80106f33:	e9 10 f5 ff ff       	jmp    80106448 <alltraps>
...
80106f3a:	6a 7e                	push   $0x7e
  jmp alltraps
80106f3c:	e9 07 f5 ff ff       	jmp    80106448 <alltraps>
...
80106f43:	6a 7f                	push   $0x7f
  jmp alltraps
80106f45:	e9 fe f4 ff ff       	jmp    80106448 <alltraps>
...
80106f4c:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106f51:	e9 f2 f4 ff ff       	jmp    80106448 <alltraps>
...
80106f58:	68 81 00 00 00       	push   $0x81
  jmp alltraps
80106f5d:	e9 e6 f4 ff ff       	jmp    80106448 <alltraps>
...
80106f64:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106f69:	e9 da f4 ff ff       	jmp    80106448 <alltraps>
...
80106f70:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106f75:	e9 ce f4 ff ff       	jmp    80106448 <alltraps>
...
80106f7c:	68 84 00 00 00       	push   $0x84
  jmp alltraps
80106f81:	e9 c2 f4 ff ff       	jmp    80106448 <alltraps>
...
80106f88:	68 85 00 00 00       	push   $0x85
  jmp alltraps
80106f8d:	e9 b6 f4 ff ff       	jmp    80106448 <alltraps>
...
80106f94:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106f99:	e9 aa f4 ff ff       	jmp    80106448 <alltraps>
...
80106fa0:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106fa5:	e9 9e f4 ff ff       	jmp    80106448 <alltraps>
...
80106fac:	68 88 00 00 00       	push   $0x88
  jmp alltraps
80106fb1:	e9 92 f4 ff ff       	jmp    80106448 <alltraps>
...
80106fb8:	68 89 00 00 00       	push   $0x89
  jmp alltraps
80106fbd:	e9 86 f4 ff ff       	jmp    80106448 <alltraps>
...
80106fc4:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106fc9:	e9 7a f4 ff ff       	jmp    80106448 <alltraps>
...
80106fd0:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106fd5:	e9 6e f4 ff ff       	jmp    80106448 <alltraps>
...
80106fdc:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
80106fe1:	e9 62 f4 ff ff       	jmp    80106448 <alltraps>
...
80106fe8:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
80106fed:	e9 56 f4 ff ff       	jmp    80106448 <alltraps>
...
80106ff4:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106ff9:	e9 4a f4 ff ff       	jmp    80106448 <alltraps>
...
80107000:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80107005:	e9 3e f4 ff ff       	jmp    80106448 <alltraps>
...
8010700c:	68 90 00 00 00       	push   $0x90
  jmp alltraps
80107011:	e9 32 f4 ff ff       	jmp    80106448 <alltraps>
...
80107018:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010701d:	e9 26 f4 ff ff       	jmp    80106448 <alltraps>
...
80107024:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80107029:	e9 1a f4 ff ff       	jmp    80106448 <alltraps>
...
80107030:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80107035:	e9 0e f4 ff ff       	jmp    80106448 <alltraps>
...
8010703c:	68 94 00 00 00       	push   $0x94
  jmp alltraps
80107041:	e9 02 f4 ff ff       	jmp    80106448 <alltraps>
...
80107048:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010704d:	e9 f6 f3 ff ff       	jmp    80106448 <alltraps>
...
80107054:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80107059:	e9 ea f3 ff ff       	jmp    80106448 <alltraps>
...
80107060:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80107065:	e9 de f3 ff ff       	jmp    80106448 <alltraps>
...
8010706c:	68 98 00 00 00       	push   $0x98
  jmp alltraps
80107071:	e9 d2 f3 ff ff       	jmp    80106448 <alltraps>
...
80107078:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010707d:	e9 c6 f3 ff ff       	jmp    80106448 <alltraps>
...
80107084:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80107089:	e9 ba f3 ff ff       	jmp    80106448 <alltraps>
...
80107090:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80107095:	e9 ae f3 ff ff       	jmp    80106448 <alltraps>
...
8010709c:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801070a1:	e9 a2 f3 ff ff       	jmp    80106448 <alltraps>
...
801070a8:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801070ad:	e9 96 f3 ff ff       	jmp    80106448 <alltraps>
...
801070b4:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801070b9:	e9 8a f3 ff ff       	jmp    80106448 <alltraps>
...
801070c0:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801070c5:	e9 7e f3 ff ff       	jmp    80106448 <alltraps>
...
801070cc:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801070d1:	e9 72 f3 ff ff       	jmp    80106448 <alltraps>
...
801070d8:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801070dd:	e9 66 f3 ff ff       	jmp    80106448 <alltraps>
...
801070e4:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801070e9:	e9 5a f3 ff ff       	jmp    80106448 <alltraps>
...
801070f0:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801070f5:	e9 4e f3 ff ff       	jmp    80106448 <alltraps>
...
801070fc:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
80107101:	e9 42 f3 ff ff       	jmp    80106448 <alltraps>
...
80107108:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010710d:	e9 36 f3 ff ff       	jmp    80106448 <alltraps>
...
80107114:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80107119:	e9 2a f3 ff ff       	jmp    80106448 <alltraps>
...
80107120:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80107125:	e9 1e f3 ff ff       	jmp    80106448 <alltraps>
...
8010712c:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
80107131:	e9 12 f3 ff ff       	jmp    80106448 <alltraps>
...
80107138:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010713d:	e9 06 f3 ff ff       	jmp    80106448 <alltraps>
...
80107144:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80107149:	e9 fa f2 ff ff       	jmp    80106448 <alltraps>
...
80107150:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80107155:	e9 ee f2 ff ff       	jmp    80106448 <alltraps>
...
8010715c:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
80107161:	e9 e2 f2 ff ff       	jmp    80106448 <alltraps>
...
80107168:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010716d:	e9 d6 f2 ff ff       	jmp    80106448 <alltraps>
...
80107174:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80107179:	e9 ca f2 ff ff       	jmp    80106448 <alltraps>
...
80107180:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80107185:	e9 be f2 ff ff       	jmp    80106448 <alltraps>
...
8010718c:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
80107191:	e9 b2 f2 ff ff       	jmp    80106448 <alltraps>
...
80107198:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010719d:	e9 a6 f2 ff ff       	jmp    80106448 <alltraps>
...
801071a4:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801071a9:	e9 9a f2 ff ff       	jmp    80106448 <alltraps>
...
801071b0:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801071b5:	e9 8e f2 ff ff       	jmp    80106448 <alltraps>
...
801071bc:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801071c1:	e9 82 f2 ff ff       	jmp    80106448 <alltraps>
...
801071c8:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801071cd:	e9 76 f2 ff ff       	jmp    80106448 <alltraps>
...
801071d4:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801071d9:	e9 6a f2 ff ff       	jmp    80106448 <alltraps>
...
801071e0:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801071e5:	e9 5e f2 ff ff       	jmp    80106448 <alltraps>
...
801071ec:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801071f1:	e9 52 f2 ff ff       	jmp    80106448 <alltraps>
...
801071f8:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801071fd:	e9 46 f2 ff ff       	jmp    80106448 <alltraps>
...
80107204:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80107209:	e9 3a f2 ff ff       	jmp    80106448 <alltraps>
...
80107210:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80107215:	e9 2e f2 ff ff       	jmp    80106448 <alltraps>
...
8010721c:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
80107221:	e9 22 f2 ff ff       	jmp    80106448 <alltraps>
...
80107228:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010722d:	e9 16 f2 ff ff       	jmp    80106448 <alltraps>
...
80107234:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80107239:	e9 0a f2 ff ff       	jmp    80106448 <alltraps>
...
80107240:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80107245:	e9 fe f1 ff ff       	jmp    80106448 <alltraps>
...
8010724c:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
80107251:	e9 f2 f1 ff ff       	jmp    80106448 <alltraps>
...
80107258:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010725d:	e9 e6 f1 ff ff       	jmp    80106448 <alltraps>
...
80107264:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80107269:	e9 da f1 ff ff       	jmp    80106448 <alltraps>
...
80107270:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80107275:	e9 ce f1 ff ff       	jmp    80106448 <alltraps>
...
8010727c:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
80107281:	e9 c2 f1 ff ff       	jmp    80106448 <alltraps>
...
80107288:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010728d:	e9 b6 f1 ff ff       	jmp    80106448 <alltraps>
...
80107294:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80107299:	e9 aa f1 ff ff       	jmp    80106448 <alltraps>
...
801072a0:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801072a5:	e9 9e f1 ff ff       	jmp    80106448 <alltraps>
...
801072ac:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801072b1:	e9 92 f1 ff ff       	jmp    80106448 <alltraps>
...
801072b8:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801072bd:	e9 86 f1 ff ff       	jmp    80106448 <alltraps>
...
801072c4:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801072c9:	e9 7a f1 ff ff       	jmp    80106448 <alltraps>
...
801072d0:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801072d5:	e9 6e f1 ff ff       	jmp    80106448 <alltraps>
...
801072dc:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801072e1:	e9 62 f1 ff ff       	jmp    80106448 <alltraps>
...
801072e8:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801072ed:	e9 56 f1 ff ff       	jmp    80106448 <alltraps>
...
801072f4:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801072f9:	e9 4a f1 ff ff       	jmp    80106448 <alltraps>
...
80107300:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80107305:	e9 3e f1 ff ff       	jmp    80106448 <alltraps>
...
8010730c:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
80107311:	e9 32 f1 ff ff       	jmp    80106448 <alltraps>
...
80107318:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010731d:	e9 26 f1 ff ff       	jmp    80106448 <alltraps>
...
80107324:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80107329:	e9 1a f1 ff ff       	jmp    80106448 <alltraps>
...
80107330:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80107335:	e9 0e f1 ff ff       	jmp    80106448 <alltraps>
...
8010733c:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
80107341:	e9 02 f1 ff ff       	jmp    80106448 <alltraps>
...
80107348:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010734d:	e9 f6 f0 ff ff       	jmp    80106448 <alltraps>
...
80107354:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80107359:	e9 ea f0 ff ff       	jmp    80106448 <alltraps>
...
80107360:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80107365:	e9 de f0 ff ff       	jmp    80106448 <alltraps>
...
8010736c:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
80107371:	e9 d2 f0 ff ff       	jmp    80106448 <alltraps>
...
80107378:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010737d:	e9 c6 f0 ff ff       	jmp    80106448 <alltraps>
...
80107384:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80107389:	e9 ba f0 ff ff       	jmp    80106448 <alltraps>
...
80107390:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80107395:	e9 ae f0 ff ff       	jmp    80106448 <alltraps>
...
8010739c:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801073a1:	e9 a2 f0 ff ff       	jmp    80106448 <alltraps>
...
801073a8:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801073ad:	e9 96 f0 ff ff       	jmp    80106448 <alltraps>
...
801073b4:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801073b9:	e9 8a f0 ff ff       	jmp    80106448 <alltraps>
...
801073c0:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801073c5:	e9 7e f0 ff ff       	jmp    80106448 <alltraps>
...
801073cc:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801073d1:	e9 72 f0 ff ff       	jmp    80106448 <alltraps>
...
801073d8:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801073dd:	e9 66 f0 ff ff       	jmp    80106448 <alltraps>
...
801073e4:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801073e9:	e9 5a f0 ff ff       	jmp    80106448 <alltraps>
...
801073f0:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801073f5:	e9 4e f0 ff ff       	jmp    80106448 <alltraps>
...
801073fc:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
80107401:	e9 42 f0 ff ff       	jmp    80106448 <alltraps>
...
80107408:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010740d:	e9 36 f0 ff ff       	jmp    80106448 <alltraps>
...
80107414:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80107419:	e9 2a f0 ff ff       	jmp    80106448 <alltraps>
...
80107420:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80107425:	e9 1e f0 ff ff       	jmp    80106448 <alltraps>
...
8010742c:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
80107431:	e9 12 f0 ff ff       	jmp    80106448 <alltraps>
...
80107438:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010743d:	e9 06 f0 ff ff       	jmp    80106448 <alltraps>
...
80107444:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80107449:	e9 fa ef ff ff       	jmp    80106448 <alltraps>
...
80107450:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80107455:	e9 ee ef ff ff       	jmp    80106448 <alltraps>
...
8010745c:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
80107461:	e9 e2 ef ff ff       	jmp    80106448 <alltraps>
...
80107468:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010746d:	e9 d6 ef ff ff       	jmp    80106448 <alltraps>
...
80107474:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80107479:	e9 ca ef ff ff       	jmp    80106448 <alltraps>
...
80107480:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80107485:	e9 be ef ff ff       	jmp    80106448 <alltraps>
...
8010748c:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80107491:	e9 b2 ef ff ff       	jmp    80106448 <alltraps>
...
80107498:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010749d:	e9 a6 ef ff ff       	jmp    80106448 <alltraps>
...
801074a4:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801074a9:	e9 9a ef ff ff       	jmp    80106448 <alltraps>
...
801074b0:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801074b5:	e9 8e ef ff ff       	jmp    80106448 <alltraps>
...
801074bc:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801074c1:	e9 82 ef ff ff       	jmp    80106448 <alltraps>
...
801074c8:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801074cd:	e9 76 ef ff ff       	jmp    80106448 <alltraps>
...
801074d4:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801074d9:	e9 6a ef ff ff       	jmp    80106448 <alltraps>
...
801074e0:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801074e5:	e9 5e ef ff ff       	jmp    80106448 <alltraps>
...
801074ec:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801074f1:	e9 52 ef ff ff       	jmp    80106448 <alltraps>
...
801074f8:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801074fd:	e9 46 ef ff ff       	jmp    80106448 <alltraps>
...
80107504:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80107509:	e9 3a ef ff ff       	jmp    80106448 <alltraps>
...
80107510:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80107515:	e9 2e ef ff ff       	jmp    80106448 <alltraps>
...
8010751c:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80107521:	e9 22 ef ff ff       	jmp    80106448 <alltraps>
...
80107528:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010752d:	e9 16 ef ff ff       	jmp    80106448 <alltraps>
...
80107534:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80107539:	e9 0a ef ff ff       	jmp    80106448 <alltraps>
...
80107540:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80107545:	e9 fe ee ff ff       	jmp    80106448 <alltraps>
	...
...
801075c9:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
801075cc:	e8 b4 b8 ff ff       	call   80102e85 <cpunum>
801075d1:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
801075d7:	05 e0 fa 10 80       	add    $0x8010fae0,%eax
...
80107a47:	c1 e0 02             	shl    $0x2,%eax
80107a4a:	03 45 08             	add    0x8(%ebp),%eax
80107a4d:	89 45 f0             	mov    %eax,-0x10(%ebp)
  if(*pde & PTE_P){
80107a50:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107a53:	8b 00                	mov    (%eax),%eax
80107a55:	83 e0 01             	and    $0x1,%eax
80107a58:	84 c0                	test   %al,%al
80107a5a:	74 17                	je     80107a73 <walkpgdir+0x38>
    pgtab = (pte_t*)p2v(PTE_ADDR(*pde));
80107a5c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107a5f:	8b 00                	mov    (%eax),%eax
80107a61:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107a66:	89 04 24             	mov    %eax,(%esp)
80107a69:	e8 4a fb ff ff       	call   801075b8 <p2v>
80107a6e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107a71:	eb 4b                	jmp    80107abe <walkpgdir+0x83>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107a73:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107a77:	74 0e                	je     80107a87 <walkpgdir+0x4c>
80107a79:	e8 79 b0 ff ff       	call   80102af7 <kalloc>
80107a7e:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107a81:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107a85:	75 07                	jne    80107a8e <walkpgdir+0x53>
      return 0;
80107a87:	b8 00 00 00 00       	mov    $0x0,%eax
80107a8c:	eb 41                	jmp    80107acf <walkpgdir+0x94>
...
80107aa4:	e8 bd d5 ff ff       	call   80105066 <memset>
...
80107aaf:	e8 f7 fa ff ff       	call   801075ab <v2p>
80107ab4:	89 c2                	mov    %eax,%edx
80107ab6:	83 ca 07             	or     $0x7,%edx
80107ab9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107abc:	89 10                	mov    %edx,(%eax)
  }
  return &pgtab[PTX(va)];
80107abe:	8b 45 0c             	mov    0xc(%ebp),%eax
80107ac1:	c1 e8 0c             	shr    $0xc,%eax
80107ac4:	25 ff 03 00 00       	and    $0x3ff,%eax
80107ac9:	c1 e0 02             	shl    $0x2,%eax
80107acc:	03 45 f4             	add    -0xc(%ebp),%eax
}
80107acf:	c9                   	leave  
80107ad0:	c3                   	ret    
...
{
80107ad1:	55                   	push   %ebp
80107ad2:	89 e5                	mov    %esp,%ebp
80107ad4:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
...
80107ae5:	03 45 10             	add    0x10(%ebp),%eax
80107ae8:	83 e8 01             	sub    $0x1,%eax
80107aeb:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107af0:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80107af3:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107afa:	00 
80107afb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107afe:	89 44 24 04          	mov    %eax,0x4(%esp)
80107b02:	8b 45 08             	mov    0x8(%ebp),%eax
80107b05:	89 04 24             	mov    %eax,(%esp)
80107b08:	e8 2e ff ff ff       	call   80107a3b <walkpgdir>
80107b0d:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107b10:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107b14:	75 07                	jne    80107b1d <mappages+0x4c>
      return -1;
80107b16:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107b1b:	eb 46                	jmp    80107b63 <mappages+0x92>
    if(*pte & PTE_P)
80107b1d:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107b20:	8b 00                	mov    (%eax),%eax
80107b22:	83 e0 01             	and    $0x1,%eax
80107b25:	84 c0                	test   %al,%al
80107b27:	74 0c                	je     80107b35 <mappages+0x64>
      panic("remap");
80107b29:	c7 04 24 58 89 10 80 	movl   $0x80108958,(%esp)
80107b30:	e8 08 8a ff ff       	call   8010053d <panic>
    *pte = pa | perm | PTE_P;
80107b35:	8b 45 18             	mov    0x18(%ebp),%eax
80107b38:	0b 45 14             	or     0x14(%ebp),%eax
80107b3b:	89 c2                	mov    %eax,%edx
80107b3d:	83 ca 01             	or     $0x1,%edx
...
80107b5b:	eb 96                	jmp    80107af3 <mappages+0x22>
      return -1;
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
...
80107b68:	53                   	push   %ebx
80107b69:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107b6c:	e8 86 af ff ff       	call   80102af7 <kalloc>
80107b71:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107b74:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107b78:	75 0a                	jne    80107b84 <setupkvm+0x1f>
    return 0;
80107b7a:	b8 00 00 00 00       	mov    $0x0,%eax
80107b7f:	e9 98 00 00 00       	jmp    80107c1c <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
80107b84:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107b8b:	00 
80107b8c:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107b93:	00 
80107b94:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107b97:	89 04 24             	mov    %eax,(%esp)
80107b9a:	e8 c7 d4 ff ff       	call   80105066 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80107b9f:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80107ba6:	e8 0d fa ff ff       	call   801075b8 <p2v>
80107bab:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80107bb0:	76 0c                	jbe    80107bbe <setupkvm+0x59>
    panic("PHYSTOP too high");
80107bb2:	c7 04 24 5e 89 10 80 	movl   $0x8010895e,(%esp)
80107bb9:	e8 7f 89 ff ff       	call   8010053d <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107bbe:	c7 45 f4 60 b6 10 80 	movl   $0x8010b660,-0xc(%ebp)
80107bc5:	eb 49                	jmp    80107c10 <setupkvm+0xab>
...
80107bc7:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107bca:	8b 48 0c             	mov    0xc(%eax),%ecx
                (uint)k->phys_start, k->perm) < 0)
80107bcd:	8b 45 f4             	mov    -0xc(%ebp),%eax
  ...
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107bd0:	8b 50 04             	mov    0x4(%eax),%edx
80107bd3:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bd6:	8b 58 08             	mov    0x8(%eax),%ebx
80107bd9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bdc:	8b 40 04             	mov    0x4(%eax),%eax
80107bdf:	29 c3                	sub    %eax,%ebx
80107be1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107be4:	8b 00                	mov    (%eax),%eax
80107be6:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107bea:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107bee:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107bf2:	89 44 24 04          	mov    %eax,0x4(%esp)
80107bf6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107bf9:	89 04 24             	mov    %eax,(%esp)
80107bfc:	e8 d0 fe ff ff       	call   80107ad1 <mappages>
80107c01:	85 c0                	test   %eax,%eax
80107c03:	79 07                	jns    80107c0c <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80107c05:	b8 00 00 00 00       	mov    $0x0,%eax
80107c0a:	eb 10                	jmp    80107c1c <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107c0c:	83 45 f4 10          	addl   $0x10,-0xc(%ebp)
80107c10:	81 7d f4 a0 b6 10 80 	cmpl   $0x8010b6a0,-0xc(%ebp)
80107c17:	72 ae                	jb     80107bc7 <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
80107c19:	8b 45 f0             	mov    -0x10(%ebp),%eax
}
80107c1c:	83 c4 34             	add    $0x34,%esp
80107c1f:	5b                   	pop    %ebx
80107c20:	5d                   	pop    %ebp
80107c21:	c3                   	ret    
...
80107c25:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107c28:	e8 38 ff ff ff       	call   80107b65 <setupkvm>
80107c2d:	a3 b8 28 11 80       	mov    %eax,0x801128b8
  switchkvm();
80107c32:	e8 02 00 00 00       	call   80107c39 <switchkvm>
}
80107c37:	c9                   	leave  
80107c38:	c3                   	ret    
...
80107c3f:	a1 b8 28 11 80       	mov    0x801128b8,%eax
80107c44:	89 04 24             	mov    %eax,(%esp)
80107c47:	e8 5f f9 ff ff       	call   801075ab <v2p>
80107c4c:	89 04 24             	mov    %eax,(%esp)
80107c4f:	e8 4c f9 ff ff       	call   801075a0 <lcr3>
}
80107c54:	c9                   	leave  
80107c55:	c3                   	ret    
...
80107c5a:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80107c5d:	e8 fd d2 ff ff       	call   80104f5f <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80107c62:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107c68:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107c6f:	83 c2 08             	add    $0x8,%edx
80107c72:	89 d3                	mov    %edx,%ebx
80107c74:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107c7b:	83 c2 08             	add    $0x8,%edx
80107c7e:	c1 ea 10             	shr    $0x10,%edx
80107c81:	89 d1                	mov    %edx,%ecx
80107c83:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107c8a:	83 c2 08             	add    $0x8,%edx
80107c8d:	c1 ea 18             	shr    $0x18,%edx
80107c90:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80107c97:	67 00 
80107c99:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80107ca0:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80107ca6:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107cad:	83 e1 f0             	and    $0xfffffff0,%ecx
80107cb0:	83 c9 09             	or     $0x9,%ecx
80107cb3:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107cb9:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107cc0:	83 c9 10             	or     $0x10,%ecx
80107cc3:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107cc9:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107cd0:	83 e1 9f             	and    $0xffffff9f,%ecx
80107cd3:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107cd9:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107ce0:	83 c9 80             	or     $0xffffff80,%ecx
80107ce3:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107ce9:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107cf0:	83 e1 f0             	and    $0xfffffff0,%ecx
80107cf3:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107cf9:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107d00:	83 e1 ef             	and    $0xffffffef,%ecx
80107d03:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107d09:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107d10:	83 e1 df             	and    $0xffffffdf,%ecx
80107d13:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107d19:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107d20:	83 c9 40             	or     $0x40,%ecx
80107d23:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107d29:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107d30:	83 e1 7f             	and    $0x7f,%ecx
80107d33:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107d39:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
80107d3f:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107d45:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
80107d4c:	83 e2 ef             	and    $0xffffffef,%edx
80107d4f:	88 90 a5 00 00 00    	mov    %dl,0xa5(%eax)
  cpu->ts.ss0 = SEG_KDATA << 3;
80107d55:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107d5b:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80107d61:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107d67:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80107d6e:	8b 52 08             	mov    0x8(%edx),%edx
80107d71:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107d77:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80107d7a:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80107d81:	e8 ef f7 ff ff       	call   80107575 <ltr>
  if(p->pgdir == 0)
80107d86:	8b 45 08             	mov    0x8(%ebp),%eax
80107d89:	8b 40 04             	mov    0x4(%eax),%eax
80107d8c:	85 c0                	test   %eax,%eax
80107d8e:	75 0c                	jne    80107d9c <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80107d90:	c7 04 24 6f 89 10 80 	movl   $0x8010896f,(%esp)
80107d97:	e8 a1 87 ff ff       	call   8010053d <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80107d9c:	8b 45 08             	mov    0x8(%ebp),%eax
80107d9f:	8b 40 04             	mov    0x4(%eax),%eax
80107da2:	89 04 24             	mov    %eax,(%esp)
80107da5:	e8 01 f8 ff ff       	call   801075ab <v2p>
80107daa:	89 04 24             	mov    %eax,(%esp)
80107dad:	e8 ee f7 ff ff       	call   801075a0 <lcr3>
  popcli();
80107db2:	e8 f0 d1 ff ff       	call   80104fa7 <popcli>
}
80107db7:	83 c4 14             	add    $0x14,%esp
80107dba:	5b                   	pop    %ebx
80107dbb:	5d                   	pop    %ebp
80107dbc:	c3                   	ret    
...
80107dc0:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  
  if(sz >= PGSIZE)
80107dc3:	81 7d 10 ff 0f 00 00 	cmpl   $0xfff,0x10(%ebp)
80107dca:	76 0c                	jbe    80107dd8 <inituvm+0x1b>
    panic("inituvm: more than a page");
80107dcc:	c7 04 24 83 89 10 80 	movl   $0x80108983,(%esp)
80107dd3:	e8 65 87 ff ff       	call   8010053d <panic>
  mem = kalloc();
80107dd8:	e8 1a ad ff ff       	call   80102af7 <kalloc>
...
80107df6:	e8 6b d2 ff ff       	call   80105066 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80107dfb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107dfe:	89 04 24             	mov    %eax,(%esp)
80107e01:	e8 a5 f7 ff ff       	call   801075ab <v2p>
80107e06:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80107e0d:	00 
80107e0e:	89 44 24 0c          	mov    %eax,0xc(%esp)
80107e12:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107e19:	00 
80107e1a:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107e21:	00 
80107e22:	8b 45 08             	mov    0x8(%ebp),%eax
80107e25:	89 04 24             	mov    %eax,(%esp)
80107e28:	e8 a4 fc ff ff       	call   80107ad1 <mappages>
  memmove(mem, init, sz);
80107e2d:	8b 45 10             	mov    0x10(%ebp),%eax
80107e30:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80107e41:	e8 f3 d2 ff ff       	call   80105139 <memmove>
}
80107e46:	c9                   	leave  
80107e47:	c3                   	ret    
...
80107e4c:	83 ec 24             	sub    $0x24,%esp
  uint i, pa, n;
  pte_t *pte;

  if((uint) addr % PGSIZE != 0)
80107e4f:	8b 45 0c             	mov    0xc(%ebp),%eax
80107e52:	25 ff 0f 00 00       	and    $0xfff,%eax
80107e57:	85 c0                	test   %eax,%eax
80107e59:	74 0c                	je     80107e67 <loaduvm+0x1f>
    panic("loaduvm: addr must be page aligned");
80107e5b:	c7 04 24 a0 89 10 80 	movl   $0x801089a0,(%esp)
80107e62:	e8 d6 86 ff ff       	call   8010053d <panic>
  for(i = 0; i < sz; i += PGSIZE){
80107e67:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80107e6e:	e9 ad 00 00 00       	jmp    80107f20 <loaduvm+0xd8>
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80107e73:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107e76:	8b 55 0c             	mov    0xc(%ebp),%edx
...
80107e8d:	e8 a9 fb ff ff       	call   80107a3b <walkpgdir>
80107e92:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107e95:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107e99:	75 0c                	jne    80107ea7 <loaduvm+0x5f>
      panic("loaduvm: address should exist");
80107e9b:	c7 04 24 c3 89 10 80 	movl   $0x801089c3,(%esp)
80107ea2:	e8 96 86 ff ff       	call   8010053d <panic>
    pa = PTE_ADDR(*pte);
80107ea7:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107eaa:	8b 00                	mov    (%eax),%eax
80107eac:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107eb1:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80107eb4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107eb7:	8b 55 18             	mov    0x18(%ebp),%edx
80107eba:	89 d1                	mov    %edx,%ecx
80107ebc:	29 c1                	sub    %eax,%ecx
80107ebe:	89 c8                	mov    %ecx,%eax
80107ec0:	3d ff 0f 00 00       	cmp    $0xfff,%eax
80107ec5:	77 11                	ja     80107ed8 <loaduvm+0x90>
      n = sz - i;
80107ec7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107eca:	8b 55 18             	mov    0x18(%ebp),%edx
80107ecd:	89 d1                	mov    %edx,%ecx
80107ecf:	29 c1                	sub    %eax,%ecx
80107ed1:	89 c8                	mov    %ecx,%eax
80107ed3:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107ed6:	eb 07                	jmp    80107edf <loaduvm+0x97>
    else
      n = PGSIZE;
80107ed8:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
80107edf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ee2:	8b 55 14             	mov    0x14(%ebp),%edx
80107ee5:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
80107ee8:	8b 45 e8             	mov    -0x18(%ebp),%eax
80107eeb:	89 04 24             	mov    %eax,(%esp)
80107eee:	e8 c5 f6 ff ff       	call   801075b8 <p2v>
80107ef3:	8b 55 f0             	mov    -0x10(%ebp),%edx
80107ef6:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107efa:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107efe:	89 44 24 04          	mov    %eax,0x4(%esp)
80107f02:	8b 45 10             	mov    0x10(%ebp),%eax
80107f05:	89 04 24             	mov    %eax,(%esp)
80107f08:	e8 49 9e ff ff       	call   80101d56 <readi>
80107f0d:	3b 45 f0             	cmp    -0x10(%ebp),%eax
80107f10:	74 07                	je     80107f19 <loaduvm+0xd1>
      return -1;
80107f12:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107f17:	eb 18                	jmp    80107f31 <loaduvm+0xe9>
  uint i, pa, n;
  pte_t *pte;
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
  for(i = 0; i < sz; i += PGSIZE){
80107f19:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80107f20:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107f23:	3b 45 18             	cmp    0x18(%ebp),%eax
80107f26:	0f 82 47 ff ff ff    	jb     80107e73 <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
80107f31:	83 c4 24             	add    $0x24,%esp
80107f34:	5b                   	pop    %ebx
80107f35:	5d                   	pop    %ebp
80107f36:	c3                   	ret    
...
80107f3a:	83 ec 38             	sub    $0x38,%esp
  char *mem;
  uint a;
...
80107f42:	79 0a                	jns    80107f4e <allocuvm+0x17>
    return 0;
80107f44:	b8 00 00 00 00       	mov    $0x0,%eax
80107f49:	e9 c1 00 00 00       	jmp    8010800f <allocuvm+0xd8>
  if(newsz < oldsz)
80107f4e:	8b 45 10             	mov    0x10(%ebp),%eax
80107f51:	3b 45 0c             	cmp    0xc(%ebp),%eax
80107f54:	73 08                	jae    80107f5e <allocuvm+0x27>
    return oldsz;
80107f56:	8b 45 0c             	mov    0xc(%ebp),%eax
80107f59:	e9 b1 00 00 00       	jmp    8010800f <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
80107f5e:	8b 45 0c             	mov    0xc(%ebp),%eax
80107f61:	05 ff 0f 00 00       	add    $0xfff,%eax
80107f66:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107f6b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
80107f6e:	e9 8d 00 00 00       	jmp    80108000 <allocuvm+0xc9>
    mem = kalloc();
80107f73:	e8 7f ab ff ff       	call   80102af7 <kalloc>
80107f78:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80107f7b:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107f7f:	75 2c                	jne    80107fad <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
80107f81:	c7 04 24 e1 89 10 80 	movl   $0x801089e1,(%esp)
80107f88:	e8 14 84 ff ff       	call   801003a1 <cprintf>
      deallocuvm(pgdir, newsz, oldsz);
80107f8d:	8b 45 0c             	mov    0xc(%ebp),%eax
80107f90:	89 44 24 08          	mov    %eax,0x8(%esp)
...
80107fa1:	e8 6b 00 00 00       	call   80108011 <deallocuvm>
      return 0;
80107fa6:	b8 00 00 00 00       	mov    $0x0,%eax
80107fab:	eb 62                	jmp    8010800f <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
...
80107fc3:	e8 9e d0 ff ff       	call   80105066 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80107fc8:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107fcb:	89 04 24             	mov    %eax,(%esp)
80107fce:	e8 d8 f5 ff ff       	call   801075ab <v2p>
...
80107fe9:	00 
80107fea:	89 54 24 04          	mov    %edx,0x4(%esp)
80107fee:	8b 45 08             	mov    0x8(%ebp),%eax
80107ff1:	89 04 24             	mov    %eax,(%esp)
80107ff4:	e8 d8 fa ff ff       	call   80107ad1 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
80108003:	3b 45 10             	cmp    0x10(%ebp),%eax
80108006:	0f 82 67 ff ff ff    	jb     80107f73 <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
8010801a:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010801d:	72 08                	jb     80108027 <deallocuvm+0x16>
    return oldsz;
8010801f:	8b 45 0c             	mov    0xc(%ebp),%eax
80108022:	e9 a4 00 00 00       	jmp    801080cb <deallocuvm+0xba>

  a = PGROUNDUP(newsz);
80108027:	8b 45 10             	mov    0x10(%ebp),%eax
8010802a:	05 ff 0f 00 00       	add    $0xfff,%eax
8010802f:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108034:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80108037:	e9 80 00 00 00       	jmp    801080bc <deallocuvm+0xab>
    pte = walkpgdir(pgdir, (char*)a, 0);
8010803c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010803f:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108046:	00 
80108047:	89 44 24 04          	mov    %eax,0x4(%esp)
8010804b:	8b 45 08             	mov    0x8(%ebp),%eax
8010804e:	89 04 24             	mov    %eax,(%esp)
80108051:	e8 e5 f9 ff ff       	call   80107a3b <walkpgdir>
80108056:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80108059:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010805d:	75 09                	jne    80108068 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
8010805f:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
80108066:	eb 4d                	jmp    801080b5 <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80108068:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010806b:	8b 00                	mov    (%eax),%eax
8010806d:	83 e0 01             	and    $0x1,%eax
80108070:	84 c0                	test   %al,%al
80108072:	74 41                	je     801080b5 <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
...
80108085:	75 0c                	jne    80108093 <deallocuvm+0x82>
        panic("kfree");
80108087:	c7 04 24 f9 89 10 80 	movl   $0x801089f9,(%esp)
8010808e:	e8 aa 84 ff ff       	call   8010053d <panic>
      char *v = p2v(pa);
80108093:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108096:	89 04 24             	mov    %eax,(%esp)
80108099:	e8 1a f5 ff ff       	call   801075b8 <p2v>
8010809e:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
801080a1:	8b 45 e8             	mov    -0x18(%ebp),%eax
801080a4:	89 04 24             	mov    %eax,(%esp)
801080a7:	e8 b2 a9 ff ff       	call   80102a5e <kfree>
      *pte = 0;
801080ac:	8b 45 f0             	mov    -0x10(%ebp),%eax
801080af:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
...
801080bf:	3b 45 0c             	cmp    0xc(%ebp),%eax
801080c2:	0f 82 74 ff ff ff    	jb     8010803c <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
801080d0:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
801080d3:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
801080d7:	75 0c                	jne    801080e5 <freevm+0x18>
    panic("freevm: no pgdir");
801080d9:	c7 04 24 ff 89 10 80 	movl   $0x801089ff,(%esp)
801080e0:	e8 58 84 ff ff       	call   8010053d <panic>
  deallocuvm(pgdir, KERNBASE, 0);
801080e5:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801080ec:	00 
801080ed:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
801080f4:	80 
801080f5:	8b 45 08             	mov    0x8(%ebp),%eax
801080f8:	89 04 24             	mov    %eax,(%esp)
801080fb:	e8 11 ff ff ff       	call   80108011 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
80108100:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80108107:	eb 3c                	jmp    80108145 <freevm+0x78>
    if(pgdir[i] & PTE_P){
80108109:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010810c:	c1 e0 02             	shl    $0x2,%eax
8010810f:	03 45 08             	add    0x8(%ebp),%eax
80108112:	8b 00                	mov    (%eax),%eax
80108114:	83 e0 01             	and    $0x1,%eax
80108117:	84 c0                	test   %al,%al
80108119:	74 26                	je     80108141 <freevm+0x74>
      char * v = p2v(PTE_ADDR(pgdir[i]));
8010811b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010811e:	c1 e0 02             	shl    $0x2,%eax
80108121:	03 45 08             	add    0x8(%ebp),%eax
80108124:	8b 00                	mov    (%eax),%eax
80108126:	25 00 f0 ff ff       	and    $0xfffff000,%eax
8010812b:	89 04 24             	mov    %eax,(%esp)
8010812e:	e8 85 f4 ff ff       	call   801075b8 <p2v>
80108133:	89 45 f0             	mov    %eax,-0x10(%ebp)
      kfree(v);
80108136:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108139:	89 04 24             	mov    %eax,(%esp)
8010813c:	e8 1d a9 ff ff       	call   80102a5e <kfree>
  uint i;
...
80108145:	81 7d f4 ff 03 00 00 	cmpl   $0x3ff,-0xc(%ebp)
8010814c:	76 bb                	jbe    80108109 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
80108154:	e8 05 a9 ff ff       	call   80102a5e <kfree>
}
80108159:	c9                   	leave  
8010815a:	c3                   	ret    
...
80108161:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108168:	00 
...
80108176:	e8 c0 f8 ff ff       	call   80107a3b <walkpgdir>
8010817b:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
8010817e:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108182:	75 0c                	jne    80108190 <clearpteu+0x35>
    panic("clearpteu");
80108184:	c7 04 24 10 8a 10 80 	movl   $0x80108a10,(%esp)
...
80108197:	83 e2 fb             	and    $0xfffffffb,%edx
8010819a:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010819d:	89 10                	mov    %edx,(%eax)
}
8010819f:	c9                   	leave  
801081a0:	c3                   	ret    
...
801081a5:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
801081a8:	e8 b8 f9 ff ff       	call   80107b65 <setupkvm>
801081ad:	89 45 f0             	mov    %eax,-0x10(%ebp)
801081b0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801081b4:	75 0a                	jne    801081c0 <copyuvm+0x1f>
    return 0;
801081b6:	b8 00 00 00 00       	mov    $0x0,%eax
801081bb:	e9 fd 00 00 00       	jmp    801082bd <copyuvm+0x11c>
  for(i = 0; i < sz; i += PGSIZE){
801081c0:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801081c7:	e9 cc 00 00 00       	jmp    80108298 <copyuvm+0xf7>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
801081cc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801081cf:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801081d6:	00 
801081d7:	89 44 24 04          	mov    %eax,0x4(%esp)
801081db:	8b 45 08             	mov    0x8(%ebp),%eax
801081de:	89 04 24             	mov    %eax,(%esp)
801081e1:	e8 55 f8 ff ff       	call   80107a3b <walkpgdir>
801081e6:	89 45 ec             	mov    %eax,-0x14(%ebp)
801081e9:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801081ed:	75 0c                	jne    801081fb <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
801081ef:	c7 04 24 1a 8a 10 80 	movl   $0x80108a1a,(%esp)
801081f6:	e8 42 83 ff ff       	call   8010053d <panic>
    if(!(*pte & PTE_P))
801081fb:	8b 45 ec             	mov    -0x14(%ebp),%eax
801081fe:	8b 00                	mov    (%eax),%eax
80108200:	83 e0 01             	and    $0x1,%eax
80108203:	85 c0                	test   %eax,%eax
80108205:	75 0c                	jne    80108213 <copyuvm+0x72>
      panic("copyuvm: page not present");
80108207:	c7 04 24 34 8a 10 80 	movl   $0x80108a34,(%esp)
...
80108225:	25 ff 0f 00 00       	and    $0xfff,%eax
8010822a:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
8010822d:	e8 c5 a8 ff ff       	call   80102af7 <kalloc>
80108232:	89 45 e0             	mov    %eax,-0x20(%ebp)
80108235:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
80108239:	74 6e                	je     801082a9 <copyuvm+0x108>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
8010823b:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010823e:	89 04 24             	mov    %eax,(%esp)
80108241:	e8 72 f3 ff ff       	call   801075b8 <p2v>
80108246:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010824d:	00 
8010824e:	89 44 24 04          	mov    %eax,0x4(%esp)
80108252:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108255:	89 04 24             	mov    %eax,(%esp)
80108258:	e8 dc ce ff ff       	call   80105139 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
8010825d:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80108260:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108263:	89 04 24             	mov    %eax,(%esp)
80108266:	e8 40 f3 ff ff       	call   801075ab <v2p>
8010826b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010826e:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80108272:	89 44 24 0c          	mov    %eax,0xc(%esp)
80108276:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010827d:	00 
8010827e:	89 54 24 04          	mov    %edx,0x4(%esp)
80108282:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108285:	89 04 24             	mov    %eax,(%esp)
80108288:	e8 44 f8 ff ff       	call   80107ad1 <mappages>
8010828d:	85 c0                	test   %eax,%eax
8010828f:	78 1b                	js     801082ac <copyuvm+0x10b>
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80108291:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
80108298:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010829b:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010829e:	0f 82 28 ff ff ff    	jb     801081cc <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
801082a7:	eb 14                	jmp    801082bd <copyuvm+0x11c>
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
      goto bad;
801082a9:	90                   	nop
801082aa:	eb 01                	jmp    801082ad <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
801082ac:	90                   	nop
...
801082b3:	e8 15 fe ff ff       	call   801080cd <freevm>
  return 0;
801082b8:	b8 00 00 00 00       	mov    $0x0,%eax
}
801082bd:	83 c4 44             	add    $0x44,%esp
801082c0:	5b                   	pop    %ebx
801082c1:	5d                   	pop    %ebp
801082c2:	c3                   	ret    
...
801082d4:	89 44 24 04          	mov    %eax,0x4(%esp)
801082d8:	8b 45 08             	mov    0x8(%ebp),%eax
801082db:	89 04 24             	mov    %eax,(%esp)
801082de:	e8 58 f7 ff ff       	call   80107a3b <walkpgdir>
801082e3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if((*pte & PTE_P) == 0)
801082e6:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082e9:	8b 00                	mov    (%eax),%eax
801082eb:	83 e0 01             	and    $0x1,%eax
801082ee:	85 c0                	test   %eax,%eax
801082f0:	75 07                	jne    801082f9 <uva2ka+0x36>
    return 0;
801082f2:	b8 00 00 00 00       	mov    $0x0,%eax
801082f7:	eb 25                	jmp    8010831e <uva2ka+0x5b>
  if((*pte & PTE_U) == 0)
801082f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801082fc:	8b 00                	mov    (%eax),%eax
801082fe:	83 e0 04             	and    $0x4,%eax
80108301:	85 c0                	test   %eax,%eax
80108303:	75 07                	jne    8010830c <uva2ka+0x49>
    return 0;
80108305:	b8 00 00 00 00       	mov    $0x0,%eax
8010830a:	eb 12                	jmp    8010831e <uva2ka+0x5b>
...
80108319:	e8 9a f2 ff ff       	call   801075b8 <p2v>
}
8010831e:	c9                   	leave  
8010831f:	c3                   	ret    
...
80108323:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;
...
80108329:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
8010832c:	e9 8b 00 00 00       	jmp    801083bc <copyout+0x9c>
    va0 = (uint)PGROUNDDOWN(va);
80108331:	8b 45 0c             	mov    0xc(%ebp),%eax
80108334:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108339:	89 45 ec             	mov    %eax,-0x14(%ebp)
    pa0 = uva2ka(pgdir, (char*)va0);
8010833c:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010833f:	89 44 24 04          	mov    %eax,0x4(%esp)
80108343:	8b 45 08             	mov    0x8(%ebp),%eax
80108346:	89 04 24             	mov    %eax,(%esp)
80108349:	e8 75 ff ff ff       	call   801082c3 <uva2ka>
8010834e:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108351:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80108355:	75 07                	jne    8010835e <copyout+0x3e>
      return -1;
80108357:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010835c:	eb 6d                	jmp    801083cb <copyout+0xab>
    n = PGSIZE - (va - va0);
8010835e:	8b 45 0c             	mov    0xc(%ebp),%eax
80108361:	8b 55 ec             	mov    -0x14(%ebp),%edx
80108364:	89 d1                	mov    %edx,%ecx
80108366:	29 c1                	sub    %eax,%ecx
80108368:	89 c8                	mov    %ecx,%eax
8010836a:	05 00 10 00 00       	add    $0x1000,%eax
8010836f:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(n > len)
80108372:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108375:	3b 45 14             	cmp    0x14(%ebp),%eax
80108378:	76 06                	jbe    80108380 <copyout+0x60>
      n = len;
8010837a:	8b 45 14             	mov    0x14(%ebp),%eax
8010837d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108380:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108383:	8b 55 0c             	mov    0xc(%ebp),%edx
80108386:	89 d1                	mov    %edx,%ecx
80108388:	29 c1                	sub    %eax,%ecx
8010838a:	89 c8                	mov    %ecx,%eax
8010838c:	03 45 e8             	add    -0x18(%ebp),%eax
8010838f:	8b 55 f0             	mov    -0x10(%ebp),%edx
80108392:	89 54 24 08          	mov    %edx,0x8(%esp)
80108396:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108399:	89 54 24 04          	mov    %edx,0x4(%esp)
8010839d:	89 04 24             	mov    %eax,(%esp)
801083a0:	e8 94 cd ff ff       	call   80105139 <memmove>
    len -= n;
801083a5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801083a8:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
801083ab:	8b 45 f0             	mov    -0x10(%ebp),%eax
801083ae:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
801083b1:	8b 45 ec             	mov    -0x14(%ebp),%eax
801083b4:	05 00 10 00 00       	add    $0x1000,%eax
801083b9:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
801083bc:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
801083c0:	0f 85 6b ff ff ff    	jne    80108331 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
