...
main(int argc, char *argv[])
{
  ...
  5a:	c7 44 24 04 3a 08 00 	movl   $0x83a,0x4(%esp)
  61:	00 
  62:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  69:	e8 f1 03 00 00       	call   45f <printf>
      break;
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f6:	0f b6 90 9c 0a 00 00 	movzbl 0xa9c(%eax),%edx
...
printf(int fd, char *fmt, ...)
{
 ...
 555:	75 27                	jne    57e <printf+0x11f>
          s = "(null)";
 557:	c7 45 f4 56 08 00 00 	movl   $0x856,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 623:	a1 b8 0a 00 00       	mov    0xab8,%eax
...
free(void *ap)
{
 ...
 6e4:	a3 b8 0a 00 00       	mov    %eax,0xab8
}
 6e9:	c9                   	leave  
 6ea:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 70a:	e8 61 fc ff ff       	call   370 <sbrk>
